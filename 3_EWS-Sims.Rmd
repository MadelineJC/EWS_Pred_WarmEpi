...
hist(constant.sims.mean.5.tau, col=alpha("cornflowerblue", 0.4), breaks = 20,add=T)
hist(warming.sims.mean.5.tau, col=alpha("red2",0.4), breaks=20)

hist(constant.sims.cv.5.tau, col=alpha("cornflowerblue", 0.4), breaks = 20,add=T)
hist(warming.sims.cv.5.tau, col=alpha("red2",0.4), breaks=20)

hist(constant.sims.variance.5.tau, col=alpha("cornflowerblue", 0.4), breaks = 20,add=T)
hist(warming.sims.variance.5.tau, col=alpha("red2",0.4), breaks=20)

hist(constant.sims.skewness.5.tau, col=alpha("cornflowerblue", 0.4), breaks = 20,add=T)
hist(warming.sims.skewness.5.tau, col=alpha("red2",0.4), breaks=20)

hist(constant.sims.kurtosis.5.tau, col=alpha("cornflowerblue", 0.4), breaks = 20,add=T)
hist(warming.sims.kurtosis.5.tau, col=alpha("red2",0.4), breaks=20)

hist(constant.sims.id.5.tau, col=alpha("cornflowerblue", 0.4), breaks = 20,add=T)
hist(warming.sims.id.5.tau, col=alpha("red2",0.4), breaks=20)

hist(constant.sims.cor.5.tau, col=alpha("cornflowerblue", 0.4), breaks = 20,add=T)
hist(warming.sims.cor.5.tau, col=alpha("red2",0.4), breaks=20)

hist(constant.sims.cov.5.tau, col=alpha("cornflowerblue", 0.4), breaks = 20,add=T)
hist(warming.sims.cov.5.tau, col=alpha("red2",0.4), breaks=20)

hist(constant.sims.decay.time.5.tau, col=alpha("cornflowerblue", 0.4), breaks = 20,add=T)
hist(warming.sims.decay.time.5.tau, col=alpha("red2",0.4), breaks=20)

hist(constant.sims.first.diff.variance.5.tau, col=alpha("cornflowerblue", 0.4), breaks = 20,add=T)
hist(warming.sims.first.diff.variance.5.tau, col=alpha("red2",0.4), breaks=20)
```
