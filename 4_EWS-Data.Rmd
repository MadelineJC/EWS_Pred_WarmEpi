...
plot(1:10, AUC_df$AUC_data, type = "p", 
     main = "Empirical Data, All Populations", xaxt = "none", xlab = "", ylim = c(0.3, 0.7), ylab = "AUC",
     col = "orchid", pch = 19)
abline(h = 0.5, lty = 3)
...
plot(1:10, AUC_df$AUC_data, type = "p", 
     main = "Empirical Data", xaxt = "none", xlab = "", ylim = c(0.2, 0.8), ylab = "AUC",
     col = "orchid", pch = 19)
points(1:10, AUC_df_without5$AUC_data, col = "red3", pch = 19)
abline(h = 0.5, lty = 3)
axis(side = 1, at = 1:10, labels = metrics_full, las = 2)
legend("bottomright", legend = c("All Populations", "Excluding Population 5"),
       col = c("red3", "orchid"), pch = 19)
```
