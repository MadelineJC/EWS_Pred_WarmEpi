...
1.  Do we calculate mean and variance over the whole time series, or only within the approach to criticality?
2.  I'm pretty sure we're not calculating the above metrics over a moving window since the null predicts no change over time... Yes?
3.  How do we calculate epsilon?

```{r}
## Original empirical time series
sub1.ts <- sub1$status.sum
sub2.ts <- sub2$status.sum
sub3.ts <- sub3$status.sum
sub4.ts <- sub4$status.sum
sub5.ts <- sub5$status.sum
sub6.ts <- sub6$status.sum
sub7.ts <- sub7$status.sum
sub8.ts <- sub8$status.sum

## Mean, variance, AR(1)
sub1.ts.mean <- mean(sub1.ts); sub1.ts.var <- var(sub1.ts); sub1.ts.ac <- acf(sub1.ts, lag.max = 1, type = "correlation", plot = FALSE)[[1]][2] 
sub2.ts.mean <- mean(sub2.ts); sub2.ts.var <- var(sub2.ts); sub2.ts.ac <- acf(sub2.ts, lag.max = 1, type = "correlation", plot = FALSE)[[1]][2] 
sub3.ts.mean <- mean(sub3.ts); sub3.ts.var <- var(sub3.ts); sub3.ts.ac <- acf(sub3.ts, lag.max = 1, type = "correlation", plot = FALSE)[[1]][2] 
sub4.ts.mean <- mean(sub4.ts); sub4.ts.var <- var(sub4.ts); sub4.ts.ac <- acf(sub4.ts, lag.max = 1, type = "correlation", plot = FALSE)[[1]][2] 
sub5.ts.mean <- mean(sub5.ts); sub5.ts.var <- var(sub5.ts); sub5.ts.ac <- acf(sub5.ts, lag.max = 1, type = "correlation", plot = FALSE)[[1]][2] 
sub6.ts.mean <- mean(sub6.ts); sub6.ts.var <- var(sub6.ts); sub6.ts.ac <- acf(sub6.ts, lag.max = 1, type = "correlation", plot = FALSE)[[1]][2] 
sub7.ts.mean <- mean(sub7.ts); sub7.ts.var <- var(sub7.ts); sub7.ts.ac <- acf(sub7.ts, lag.max = 1, type = "correlation", plot = FALSE)[[1]][2] 
sub8.ts.mean <- mean(sub8.ts); sub8.ts.var <- var(sub8.ts); sub8.ts.ac <- acf(sub8.ts, lag.max = 1, type = "correlation", plot = FALSE)[[1]][2] 

## Error generated as Gaussian noise
epsilon <- rnorm(n = 1, mean = 0, sd = 1) # Where do the mean and standard deviation come from?
sigma <- 1 # Let's not scale epsilon for now, just while we get the pipeline functional

## Function
AR.func <- function(x.prev, mu, v, A1, sigma, epsilon){
  alpha.1 = A1 # Where A(1) is the autocorrelation at lag 1 from the residual time series (est. using acf())
  alpha.0 = mu*(1 - alpha.1) # Where mu is the mean
  sigma = sqrt(v*(1 - alpha.1^2)) # Where v is the variance
  x.next = alpha.1*x.prev + alpha.0 + sigma*epsilon # How do we get a value for epsilon?
  return(x.next)
}

## Implementation
x.prev <- 0
set.seed(1); epsilon <- rnorm(n = 119, mean = 1, sd = 1)
surr.ts <- c(x.prev)
for (i in 1:119){
  x.next <- AR.func(x.prev = x.prev, mu = sub1.ts.mean, v = sub1.ts.var, A1 = sub1.ts.ac, sigma = 1, epsilon = epsilon[i])
...
for (i in 1:1000){
  x.prev <- 0
  set.seed(seed[i]); epsilon <- rnorm(n = 119, mean = 1, sd = 1)
  surr.ts <- c(x.prev)
  for (j in 1:119){
      x.next <- AR.func(x.prev = x.prev, mu = sub1.ts.mean, v = sub1.ts.var, A1 = sub1.ts.ac, sigma = 1, epsilon = epsilon[j])
      surr.ts <- c(surr.ts, x.next)
      x.prev <- x.next
  }
...
for (i in 1:1000){
  ...
  surr.ts <- c(x.prev)
  for (j in 1:119){
      x.next <- AR.func(x.prev = x.prev, mu = sub2.ts.mean, v = sub2.ts.var, A1 = sub2.ts.ac, sigma = 1, epsilon = epsilon[j])
      surr.ts <- c(surr.ts, x.next)
      x.prev <- x.next
  }
...
for (i in 1:1000){
  ...
  surr.ts <- c(x.prev)
  for (j in 1:119){
      x.next <- AR.func(x.prev = x.prev, mu = sub3.ts.mean, v = sub3.ts.var, A1 = sub3.ts.ac, sigma = 1, epsilon = epsilon[j])
      surr.ts <- c(surr.ts, x.next)
      x.prev <- x.next
  }
...
for (i in 1:1000){
  ...
  surr.ts <- c(x.prev)
  for (j in 1:119){
      x.next <- AR.func(x.prev = x.prev, mu = sub4.ts.mean, v = sub4.ts.var, A1 = sub4.ts.ac, sigma = 1, epsilon = epsilon[j])
      surr.ts <- c(surr.ts, x.next)
      x.prev <- x.next
  }
...
for (i in 1:1000){
  ...
  surr.ts <- c(x.prev)
  for (j in 1:119){
      x.next <- AR.func(x.prev = x.prev, mu = sub5.ts.mean, v = sub5.ts.var, A1 = sub5.ts.ac, sigma = 1, epsilon = epsilon[j])
      surr.ts <- c(surr.ts, x.next)
      x.prev <- x.next
  }
...
for (i in 1:1000){
  ...
  surr.ts <- c(x.prev)
  for (j in 1:119){
      x.next <- AR.func(x.prev = x.prev, mu = sub6.ts.mean, v = sub6.ts.var, A1 = sub6.ts.ac, sigma = 1, epsilon = epsilon[j])
      surr.ts <- c(surr.ts, x.next)
      x.prev <- x.next
  }
...
for (i in 1:1000){
  ...
  surr.ts <- c(x.prev)
  for (j in 1:119){
      x.next <- AR.func(x.prev = x.prev, mu = sub7.ts.mean, v = sub7.ts.var, A1 = sub7.ts.ac, sigma = 1, epsilon = epsilon[j])
      surr.ts <- c(surr.ts, x.next)
      x.prev <- x.next
  }
...
for (i in 1:1000){
  ...
  surr.ts <- c(x.prev)
  for (j in 1:119){
      x.next <- AR.func(x.prev = x.prev, mu = sub8.ts.mean, v = sub8.ts.var, A1 = sub8.ts.ac, sigma = 1, epsilon = epsilon[j])
      surr.ts <- c(surr.ts, x.next)
      x.prev <- x.next
  }
...
## Subpopulation 1
plot(seq(3, 120, 3), sub1.ts, type = "l", lwd = 2,
     main = "Subpopulation 1", xlab = "Day", ylab = "Prevalence", ylim = c(-0.5, 1))
for (i in 1:6){
  lines(seq(3, 120, 3), sub1.surr.df[ , i], col = cols[i])
}

## Subpopulation 2
plot(seq(3, 120, 3), sub2.ts, type = "l", lwd = 2,
     main = "Subpopulation 2", xlab = "Day", ylab = "Prevalence", ylim = c(-0.5, 1.5))
for (i in 1:6){
  lines(seq(3, 120, 3), sub2.surr.df[ , i], col = cols[i])
}

## Subpopulation 3
plot(seq(3, 120, 3), sub3.ts, type = "l", lwd = 2,
     main = "Subpopulation 3", xlab = "Day", ylab = "Prevalence", ylim = c(-0.5, 2.5))
for (i in 1:6){
  lines(seq(3, 120, 3), sub3.surr.df[ , i], col = cols[i])
}

## Subpopulation 4
plot(seq(3, 120, 3), sub4.ts, type = "l", lwd = 2,
     main = "Subpopulation 4", xlab = "Day", ylab = "Prevalence", ylim = c(-0.5, 2.5))
for (i in 1:6){
  lines(seq(3, 120, 3), sub4.surr.df[ , i], col = cols[i])
}

## Subpopulation 5
plot(seq(3, 120, 3), sub5.ts, type = "l", lwd = 2,
     main = "Subpopulation 5", xlab = "Day", ylab = "Prevalence", ylim = c(-0.5, 5))
for (i in 1:6){
  lines(seq(3, 120, 3), sub5.surr.df[ , i], col = cols[i])
}

## Subpopulation 6
plot(seq(3, 120, 3), sub6.ts, type = "l", lwd = 2,
     main = "Subpopulation 6", xlab = "Day", ylab = "Prevalence", ylim = c(-0.5, 5))
for (i in 1:6){
  lines(seq(3, 120, 3), sub6.surr.df[ , i], col = cols[i])
}

## Subpopulation 7
plot(seq(3, 120, 3), sub7.ts, type = "l", lwd = 2,
     main = "Subpopulation 7", xlab = "Day", ylab = "Prevalence", ylim = c(-0.5, 7.5))
for (i in 1:6){
  lines(seq(3, 120, 3), sub7.surr.df[ , i], col = cols[i])
}

## Subpopulation 8
plot(seq(3, 120, 3), sub8.ts, type = "l", lwd = 2,
     main = "Subpopulation 8", xlab = "Day", ylab = "Prevalence", ylim = c(-0.5, 7.5))
for (i in 1:6){
...
```{r}
sub1.surr.nulls <- as.list(sub1.surr.df[1:20, ])
sub2.surr.nulls <- as.list(sub2.surr.df[1:20, ])
sub3.surr.nulls <- as.list(sub3.surr.df[1:20, ])
sub4.surr.nulls <- as.list(sub4.surr.df[1:20, ])
sub5.surr.nulls <- as.list(sub5.surr.df[1:20, ])
sub6.surr.nulls <- as.list(sub6.surr.df[1:20, ])
sub7.surr.nulls <- as.list(sub7.surr.df[1:20, ])
sub8.surr.nulls <- as.list(sub8.surr.df[1:20, ])
```
...
```{r}
sub1.surr.nulls.mean <- list(); sub1.surr.nulls.sd <- list()
sub2.surr.nulls.mean <- list(); sub2.surr.nulls.sd <- list()
sub3.surr.nulls.mean <- list(); sub3.surr.nulls.sd <- list()
sub4.surr.nulls.mean <- list(); sub4.surr.nulls.sd <- list()
sub5.surr.nulls.mean <- list(); sub5.surr.nulls.sd <- list()
sub6.surr.nulls.mean <- list(); sub6.surr.nulls.sd <- list()
sub7.surr.nulls.mean <- list(); sub7.surr.nulls.sd <- list()
sub8.surr.nulls.mean <- list(); sub8.surr.nulls.sd <- list()

for (i in 1:length(sub1.surr.nulls)){
  sub1.surr.nulls.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub1.surr.nulls[[i]], window = 5, step = 1)
  sub1.surr.nulls.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub1.surr.nulls[[i]], window = 5, step = 1)
  
  sub2.surr.nulls.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub2.surr.nulls[[i]], window = 5, step = 1)
  sub2.surr.nulls.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub2.surr.nulls[[i]], window = 5, step = 1)
  
  sub3.surr.nulls.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub3.surr.nulls[[i]], window = 5, step = 1)
  sub3.surr.nulls.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub3.surr.nulls[[i]], window = 5, step = 1)
  
  sub4.surr.nulls.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub4.surr.nulls[[i]], window = 5, step = 1)
  sub4.surr.nulls.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub4.surr.nulls[[i]], window = 5, step = 1)
  
  sub5.surr.nulls.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub5.surr.nulls[[i]], window = 5, step = 1)
  sub5.surr.nulls.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub5.surr.nulls[[i]], window = 5, step = 1)
  
  sub6.surr.nulls.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub6.surr.nulls[[i]], window = 5, step = 1)
  sub6.surr.nulls.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub6.surr.nulls[[i]], window = 5, step = 1)
  
  sub7.surr.nulls.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub7.surr.nulls[[i]], window = 5, step = 1)
  sub7.surr.nulls.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub7.surr.nulls[[i]], window = 5, step = 1)
  
  sub8.surr.nulls.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub8.surr.nulls[[i]], window = 5, step = 1)
  sub8.surr.nulls.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub8.surr.nulls[[i]], window = 5, step = 1)
}
```
...
```{r}
sub1.surr.nulls.var <- list(); sub2.surr.nulls.var <- list(); sub3.surr.nulls.var <- list(); sub4.surr.nulls.var <- list()
sub5.surr.nulls.var <- list(); sub6.surr.nulls.var <- list(); sub7.surr.nulls.var <- list(); sub8.surr.nulls.var <- list()
for (i in 1:1000){
  sub1.surr.nulls.var[[i]] <- sub1.surr.nulls.sd[[i]]^2
  sub2.surr.nulls.var[[i]] <- sub2.surr.nulls.sd[[i]]^2
  sub3.surr.nulls.var[[i]] <- sub3.surr.nulls.sd[[i]]^2
  sub4.surr.nulls.var[[i]] <- sub4.surr.nulls.sd[[i]]^2
  sub5.surr.nulls.var[[i]] <- sub5.surr.nulls.sd[[i]]^2
  sub6.surr.nulls.var[[i]] <- sub6.surr.nulls.sd[[i]]^2
  sub7.surr.nulls.var[[i]] <- sub7.surr.nulls.sd[[i]]^2
  sub8.surr.nulls.var[[i]] <- sub8.surr.nulls.sd[[i]]^2
}
```
...
```{r}
sub1.surr.nulls.id <- list(); sub2.surr.nulls.id <- list(); sub3.surr.nulls.id <- list(); sub4.surr.nulls.id <- list()
sub5.surr.nulls.id <- list(); sub6.surr.nulls.id <- list(); sub7.surr.nulls.id <- list(); sub8.surr.nulls.id <- list()
for (i in 1:1000){
  sub1.surr.nulls.id[[i]] <- sub1.surr.nulls.var[[i]]/(sub1.surr.nulls.mean[[i]] + 1e-10)
  sub2.surr.nulls.id[[i]] <- sub2.surr.nulls.var[[i]]/(sub2.surr.nulls.mean[[i]] + 1e-10)
  sub3.surr.nulls.id[[i]] <- sub3.surr.nulls.var[[i]]/(sub3.surr.nulls.mean[[i]] + 1e-10)
  sub4.surr.nulls.id[[i]] <- sub4.surr.nulls.var[[i]]/(sub4.surr.nulls.mean[[i]] + 1e-10)
  sub5.surr.nulls.id[[i]] <- sub5.surr.nulls.var[[i]]/(sub5.surr.nulls.mean[[i]] + 1e-10)
  sub6.surr.nulls.id[[i]] <- sub6.surr.nulls.var[[i]]/(sub6.surr.nulls.mean[[i]] + 1e-10)
  sub7.surr.nulls.id[[i]] <- sub7.surr.nulls.var[[i]]/(sub7.surr.nulls.mean[[i]] + 1e-10)
  sub8.surr.nulls.id[[i]] <- sub8.surr.nulls.var[[i]]/(sub8.surr.nulls.mean[[i]] + 1e-10)
}
```
...
```{r}
sub1.surr.null.mean.tau <- c(); sub2.surr.null.mean.tau <- c(); sub3.surr.null.mean.tau <- c(); sub4.surr.null.mean.tau <- c()
sub5.surr.null.mean.tau <- c(); sub6.surr.null.mean.tau <- c(); sub7.surr.null.mean.tau <- c(); sub8.surr.null.mean.tau <- c()
t <- seq(1, 15, 1)
for (i in 1:1000){
  sub1.surr.null.mean.tau[i] <- cor(sub1.surr.nulls.mean[[i]], t, method = "kendall")
  sub2.surr.null.mean.tau[i] <- cor(sub2.surr.nulls.mean[[i]], t, method = "kendall")
  sub3.surr.null.mean.tau[i] <- cor(sub3.surr.nulls.mean[[i]], t, method = "kendall")
  sub4.surr.null.mean.tau[i] <- cor(sub4.surr.nulls.mean[[i]], t, method = "kendall")
  sub5.surr.null.mean.tau[i] <- cor(sub5.surr.nulls.mean[[i]], t, method = "kendall")
  sub6.surr.null.mean.tau[i] <- cor(sub6.surr.nulls.mean[[i]], t, method = "kendall")
  sub7.surr.null.mean.tau[i] <- cor(sub7.surr.nulls.mean[[i]], t, method = "kendall")
  sub8.surr.null.mean.tau[i] <- cor(sub8.surr.nulls.mean[[i]], t, method = "kendall")
}
```
...
```{r}
sub1.surr.null.var.tau <- c(); sub2.surr.null.var.tau <- c(); sub3.surr.null.var.tau <- c(); sub4.surr.null.var.tau <- c()
sub5.surr.null.var.tau <- c(); sub6.surr.null.var.tau <- c(); sub7.surr.null.var.tau <- c(); sub8.surr.null.var.tau <- c()
t <- seq(1, 15, 1)
for (i in 1:1000){
  sub1.surr.null.var.tau[i] <- cor(sub1.surr.nulls.var[[i]], t, method = "kendall")
  sub2.surr.null.var.tau[i] <- cor(sub2.surr.nulls.var[[i]], t, method = "kendall")
  sub3.surr.null.var.tau[i] <- cor(sub3.surr.nulls.var[[i]], t, method = "kendall")
  sub4.surr.null.var.tau[i] <- cor(sub4.surr.nulls.var[[i]], t, method = "kendall")
  sub5.surr.null.var.tau[i] <- cor(sub5.surr.nulls.var[[i]], t, method = "kendall")
  sub6.surr.null.var.tau[i] <- cor(sub6.surr.nulls.var[[i]], t, method = "kendall")
  sub7.surr.null.var.tau[i] <- cor(sub7.surr.nulls.var[[i]], t, method = "kendall")
  sub8.surr.null.var.tau[i] <- cor(sub8.surr.nulls.var[[i]], t, method = "kendall")
}
```
...
```{r}
sub1.surr.null.id.tau <- c(); sub2.surr.null.id.tau <- c(); sub3.surr.null.id.tau <- c(); sub4.surr.null.id.tau <- c()
sub5.surr.null.id.tau <- c(); sub6.surr.null.id.tau <- c(); sub7.surr.null.id.tau <- c(); sub8.surr.null.id.tau <- c()
t <- seq(1, 15, 1)
for (i in 1:1000){
  sub1.surr.null.id.tau[i] <- cor(sub1.surr.nulls.id[[i]], t, method = "kendall")
  sub2.surr.null.id.tau[i] <- cor(sub2.surr.nulls.id[[i]], t, method = "kendall")
  sub3.surr.null.id.tau[i] <- cor(sub3.surr.nulls.id[[i]], t, method = "kendall")
  sub4.surr.null.id.tau[i] <- cor(sub4.surr.nulls.id[[i]], t, method = "kendall")
  sub5.surr.null.id.tau[i] <- cor(sub5.surr.nulls.id[[i]], t, method = "kendall")
  sub6.surr.null.id.tau[i] <- cor(sub6.surr.nulls.id[[i]], t, method = "kendall")
  sub7.surr.null.id.tau[i] <- cor(sub7.surr.nulls.id[[i]], t, method = "kendall")
  sub8.surr.null.id.tau[i] <- cor(sub8.surr.nulls.id[[i]], t, method = "kendall")
}
```
...
surr.null.mean.taus <- list(
  sub1.surr.null.mean.tau,
  sub2.surr.null.mean.tau,
  sub3.surr.null.mean.tau,
  sub4.surr.null.mean.tau,
  sub5.surr.null.mean.tau,
  sub6.surr.null.mean.tau,
  sub7.surr.null.mean.tau,
  sub8.surr.null.mean.tau
)
cols <- c(rep("#A7C7E7", 4), rep("#F6799D", 4))
mains <- c("pop1.mean", "pop2.mean", "pop3.mean", "pop4.mean", "pop5.mean", "pop6.mean", "pop7.mean", "pop8.mean")
true.taus <- c(constant.mean.tau, warming.mean.tau)
...
surr.null.var.taus <- list(
  sub1.surr.null.var.tau,
  sub2.surr.null.var.tau,
  sub3.surr.null.var.tau,
  sub4.surr.null.var.tau,
  sub5.surr.null.var.tau,
  sub6.surr.null.var.tau,
  sub7.surr.null.var.tau,
  sub8.surr.null.var.tau
)
cols <- c(rep("#A7C7E7", 4), rep("#F6799D", 4))
mains <- c("pop1.var", "pop2.var", "pop3.var", "pop4.var", "pop5.var", "pop6.var", "pop7.var", "pop8.var")
true.taus <- c(constant.var.tau, warming.var.tau)
...
surr.null.id.taus <- list(
  sub1.surr.null.id.tau,
  sub2.surr.null.id.tau,
  sub3.surr.null.id.tau,
  sub4.surr.null.id.tau,
  sub5.surr.null.id.tau,
  sub6.surr.null.id.tau,
  sub7.surr.null.id.tau,
  sub8.surr.null.id.tau
)
cols <- c(rep("#A7C7E7", 4), rep("#F6799D", 4))
mains <- c("pop1.id", "pop2.id", "pop3.id", "pop4.id", "pop5.id", "pop6.id", "pop7.id", "pop8.id")
true.taus <- c(constant.id.tau, warming.id.tau)
