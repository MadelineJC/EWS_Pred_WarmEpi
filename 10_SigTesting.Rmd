...
## Estimating Partial Autocorrelation of Pre-Bifurcation Time Series
...
par(mfrow = c(2, 4))
plot(acf(sub1.ts, lag.max = NULL, type = "partial", plot = FALSE), main = "First Half of Time Series: Population 1", col = "cornflowerblue")
plot(acf(sub2.ts, lag.max = NULL, type = "partial", plot = FALSE), main = "First Half of Time Series: Population 2", col = "cornflowerblue")
plot(acf(sub3.ts, lag.max = NULL, type = "partial", plot = FALSE), main = "First Half of Time Series: Population 3", col = "cornflowerblue")
plot(acf(sub4.ts, lag.max = NULL, type = "partial", plot = FALSE), main = "First Half of Time Series: Population 4", col = "cornflowerblue")
plot(acf(sub5.ts, lag.max = NULL, type = "partial", plot = FALSE), main = "Pre-Bifurcation Time Series: Population 5", col = "#C82C2D")
plot(acf(sub6.ts, lag.max = NULL, type = "partial", plot = FALSE), main = "Pre-Bifurcation Time Series: Population 6", col = "#C82C2D")
plot(acf(sub7.ts, lag.max = NULL, type = "partial", plot = FALSE), main = "Pre-Bifurcation Time Series: Population 7", col = "#C82C2D")
plot(acf(sub8.ts, lag.max = NULL, type = "partial", plot = FALSE), main = "Pre-Bifurcation Time Series: Population 8", col = "#C82C2D")
par(mfrow = c(1, 1))
```
...
# (4) AR-1 Process with Poisson Distribution
...
```{r}
model <- stan_model("StanModels/10_SigTesting_AR1-Pois.stan")
```
...
# (5) AR-1 Process with Negative Binomial Distribution

## Compiling Model

```{r}
model <- stan_model("StanModels/10_SigTesting_AR1-NegBinom-AltParm.stan")
```
...
temp <- y_tilde[init.zero , ]
# select.rows <- c(sample(nrow(y_tilde), 1000, replace = FALSE))
sub1.surr.nbinom.null <- list()
for(i in 1:1000){
  sub1.surr.nbinom.null[[i]] <- as.numeric(temp[i, ])
}
...
temp <- y_tilde[init.zero , ]
# select.rows <- c(sample(nrow(y_tilde), 1000, replace = FALSE))
sub2.surr.nbinom.null <- list()
for(i in 1:1000){
  sub2.surr.nbinom.null[[i]] <- as.numeric(temp[i, ])
}
...
temp <- y_tilde[init.zero , ]
# select.rows <- c(sample(nrow(y_tilde), 1000, replace = FALSE))
sub3.surr.nbinom.null <- list()
for(i in 1:1000){
  sub3.surr.nbinom.null[[i]] <- as.numeric(temp[i, ])
}
...
temp <- y_tilde[init.zero , ]
# select.rows <- c(sample(nrow(y_tilde), 1000, replace = FALSE))
sub4.surr.nbinom.null <- list()
for(i in 1:1000){
  sub4.surr.nbinom.null[[i]] <- as.numeric(temp[i, ])
}
...
temp <- y_tilde[init.zero , ]
# select.rows <- c(sample(nrow(y_tilde), 1000, replace = FALSE))
sub5.surr.nbinom.null <- list()
for(i in 1:1000){
  sub5.surr.nbinom.null[[i]] <- as.numeric(temp[i, ])
}
...
temp <- y_tilde[init.zero , ]
# select.rows <- c(sample(nrow(y_tilde), 1000, replace = FALSE))
sub6.surr.nbinom.null <- list()
for(i in 1:1000){
  sub6.surr.nbinom.null[[i]] <- as.numeric(temp[i, ])
}
...
temp <- y_tilde[init.zero , ]
# select.rows <- c(sample(nrow(y_tilde), 1000, replace = FALSE))
sub7.surr.nbinom.null <- list()
for(i in 1:1000){
  sub7.surr.nbinom.null[[i]] <- as.numeric(temp[i, ])
}
...
temp <- y_tilde[init.zero , ]
# select.rows <- c(sample(nrow(y_tilde), 1000, replace = FALSE))
sub8.surr.nbinom.null <- list()
for(i in 1:1000){
  sub8.surr.nbinom.null[[i]] <- as.numeric(temp[i, ])
}
```
...
```{r}
sub1.surr.nbinom.null.mean <- list(); sub1.surr.nbinom.null.sd <- list()
sub2.surr.nbinom.null.mean <- list(); sub2.surr.nbinom.null.sd <- list()
sub3.surr.nbinom.null.mean <- list(); sub3.surr.nbinom.null.sd <- list()
sub4.surr.nbinom.null.mean <- list(); sub4.surr.nbinom.null.sd <- list()
sub5.surr.nbinom.null.mean <- list(); sub5.surr.nbinom.null.sd <- list()
sub6.surr.nbinom.null.mean <- list(); sub6.surr.nbinom.null.sd <- list()
sub7.surr.nbinom.null.mean <- list(); sub7.surr.nbinom.null.sd <- list()
sub8.surr.nbinom.null.mean <- list(); sub8.surr.nbinom.null.sd <- list()

for (i in 1:length(sub1.surr.nbinom.null)){
  sub1.surr.nbinom.null.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub1.surr.nbinom.null[[i]], window = 5, step = 1)
  sub1.surr.nbinom.null.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub1.surr.nbinom.null[[i]], window = 5, step = 1)
  
  sub2.surr.nbinom.null.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub2.surr.nbinom.null[[i]], window = 5, step = 1)
  sub2.surr.nbinom.null.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub2.surr.nbinom.null[[i]], window = 5, step = 1)
  
  sub3.surr.nbinom.null.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub3.surr.nbinom.null[[i]], window = 5, step = 1)
  sub3.surr.nbinom.null.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub3.surr.nbinom.null[[i]], window = 5, step = 1)
  
  sub4.surr.nbinom.null.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub4.surr.nbinom.null[[i]], window = 5, step = 1)
  sub4.surr.nbinom.null.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub4.surr.nbinom.null[[i]], window = 5, step = 1)
  
  sub5.surr.nbinom.null.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub5.surr.nbinom.null[[i]], window = 5, step = 1)
  sub5.surr.nbinom.null.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub5.surr.nbinom.null[[i]], window = 5, step = 1)
  
  sub6.surr.nbinom.null.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub6.surr.nbinom.null[[i]], window = 5, step = 1)
  sub6.surr.nbinom.null.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub6.surr.nbinom.null[[i]], window = 5, step = 1)
  
  sub7.surr.nbinom.null.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub7.surr.nbinom.null[[i]], window = 5, step = 1)
  sub7.surr.nbinom.null.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub7.surr.nbinom.null[[i]], window = 5, step = 1)
  
  sub8.surr.nbinom.null.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub8.surr.nbinom.null[[i]], window = 5, step = 1)
  sub8.surr.nbinom.null.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub8.surr.nbinom.null[[i]], window = 5, step = 1)
}
```
...
```{r}
sub1.surr.nbinom.null.var <- list(); sub2.surr.nbinom.null.var <- list(); sub3.surr.nbinom.null.var <- list(); sub4.surr.nbinom.null.var <- list()
sub5.surr.nbinom.null.var <- list(); sub6.surr.nbinom.null.var <- list(); sub7.surr.nbinom.null.var <- list(); sub8.surr.nbinom.null.var <- list()
for (i in 1:1000){
  sub1.surr.nbinom.null.var[[i]] <- sub1.surr.nbinom.null.sd[[i]]^2
  sub2.surr.nbinom.null.var[[i]] <- sub2.surr.nbinom.null.sd[[i]]^2
  sub3.surr.nbinom.null.var[[i]] <- sub3.surr.nbinom.null.sd[[i]]^2
  sub4.surr.nbinom.null.var[[i]] <- sub4.surr.nbinom.null.sd[[i]]^2
  sub5.surr.nbinom.null.var[[i]] <- sub5.surr.nbinom.null.sd[[i]]^2
  sub6.surr.nbinom.null.var[[i]] <- sub6.surr.nbinom.null.sd[[i]]^2
  sub7.surr.nbinom.null.var[[i]] <- sub7.surr.nbinom.null.sd[[i]]^2
  sub8.surr.nbinom.null.var[[i]] <- sub8.surr.nbinom.null.sd[[i]]^2
}
```
...
```{r}
sub1.surr.nbinom.null.id <- list(); sub2.surr.nbinom.null.id <- list(); sub3.surr.nbinom.null.id <- list(); sub4.surr.nbinom.null.id <- list()
sub5.surr.nbinom.null.id <- list(); sub6.surr.nbinom.null.id <- list(); sub7.surr.nbinom.null.id <- list(); sub8.surr.nbinom.null.id <- list()
for (i in 1:1000){
  sub1.surr.nbinom.null.id[[i]] <- sub1.surr.nbinom.null.var[[i]]/(sub1.surr.nbinom.null.mean[[i]] + 1e-10)
  sub2.surr.nbinom.null.id[[i]] <- sub2.surr.nbinom.null.var[[i]]/(sub2.surr.nbinom.null.mean[[i]] + 1e-10)
  sub3.surr.nbinom.null.id[[i]] <- sub3.surr.nbinom.null.var[[i]]/(sub3.surr.nbinom.null.mean[[i]] + 1e-10)
  sub4.surr.nbinom.null.id[[i]] <- sub4.surr.nbinom.null.var[[i]]/(sub4.surr.nbinom.null.mean[[i]] + 1e-10)
  sub5.surr.nbinom.null.id[[i]] <- sub5.surr.nbinom.null.var[[i]]/(sub5.surr.nbinom.null.mean[[i]] + 1e-10)
  sub6.surr.nbinom.null.id[[i]] <- sub6.surr.nbinom.null.var[[i]]/(sub6.surr.nbinom.null.mean[[i]] + 1e-10)
  sub7.surr.nbinom.null.id[[i]] <- sub7.surr.nbinom.null.var[[i]]/(sub7.surr.nbinom.null.mean[[i]] + 1e-10)
  sub8.surr.nbinom.null.id[[i]] <- sub8.surr.nbinom.null.var[[i]]/(sub8.surr.nbinom.null.mean[[i]] + 1e-10)
}
```
...
```{r}
sub1.surr.nbinom.null.mean.taus <- c(); sub2.surr.nbinom.null.mean.taus <- c(); sub3.surr.nbinom.null.mean.taus <- c(); sub4.surr.nbinom.null.mean.taus <- c()
sub5.surr.nbinom.null.mean.taus <- c(); sub6.surr.nbinom.null.mean.taus <- c(); sub7.surr.nbinom.null.mean.taus <- c(); sub8.surr.nbinom.null.mean.taus <- c()
t <- seq(1, 15, 1)
for (i in 1:1000){
  sub1.surr.nbinom.null.mean.taus[i] <- cor(sub1.surr.nbinom.null.mean[[i]], t, method = "kendall")
  sub2.surr.nbinom.null.mean.taus[i] <- cor(sub2.surr.nbinom.null.mean[[i]], t, method = "kendall")
  sub3.surr.nbinom.null.mean.taus[i] <- cor(sub3.surr.nbinom.null.mean[[i]], t, method = "kendall")
  sub4.surr.nbinom.null.mean.taus[i] <- cor(sub4.surr.nbinom.null.mean[[i]], t, method = "kendall")
  sub5.surr.nbinom.null.mean.taus[i] <- cor(sub5.surr.nbinom.null.mean[[i]], t, method = "kendall")
  sub6.surr.nbinom.null.mean.taus[i] <- cor(sub6.surr.nbinom.null.mean[[i]], t, method = "kendall")
  sub7.surr.nbinom.null.mean.taus[i] <- cor(sub7.surr.nbinom.null.mean[[i]], t, method = "kendall")
  sub8.surr.nbinom.null.mean.taus[i] <- cor(sub8.surr.nbinom.null.mean[[i]], t, method = "kendall")
}
```
...
```{r}
sub1.surr.nbinom.null.var.taus <- c(); sub2.surr.nbinom.null.var.taus <- c(); sub3.surr.nbinom.null.var.taus <- c(); sub4.surr.nbinom.null.var.taus <- c()
sub5.surr.nbinom.null.var.taus <- c(); sub6.surr.nbinom.null.var.taus <- c(); sub7.surr.nbinom.null.var.taus <- c(); sub8.surr.nbinom.null.var.taus <- c()
t <- seq(1, 15, 1)
for (i in 1:1000){
  sub1.surr.nbinom.null.var.taus[i] <- cor(sub1.surr.nbinom.null.var[[i]], t, method = "kendall")
  sub2.surr.nbinom.null.var.taus[i] <- cor(sub2.surr.nbinom.null.var[[i]], t, method = "kendall")
  sub3.surr.nbinom.null.var.taus[i] <- cor(sub3.surr.nbinom.null.var[[i]], t, method = "kendall")
  sub4.surr.nbinom.null.var.taus[i] <- cor(sub4.surr.nbinom.null.var[[i]], t, method = "kendall")
  sub5.surr.nbinom.null.var.taus[i] <- cor(sub5.surr.nbinom.null.var[[i]], t, method = "kendall")
  sub6.surr.nbinom.null.var.taus[i] <- cor(sub6.surr.nbinom.null.var[[i]], t, method = "kendall")
  sub7.surr.nbinom.null.var.taus[i] <- cor(sub7.surr.nbinom.null.var[[i]], t, method = "kendall")
  sub8.surr.nbinom.null.var.taus[i] <- cor(sub8.surr.nbinom.null.var[[i]], t, method = "kendall")
}
```
...
```{r}
sub1.surr.nbinom.null.id.taus <- c(); sub2.surr.nbinom.null.id.taus <- c(); sub3.surr.nbinom.null.id.taus <- c(); sub4.surr.nbinom.null.id.taus <- c()
sub5.surr.nbinom.null.id.taus <- c(); sub6.surr.nbinom.null.id.taus <- c(); sub7.surr.nbinom.null.id.taus <- c(); sub8.surr.nbinom.null.id.taus <- c()
t <- seq(1, 15, 1)
for (i in 1:1000){
  sub1.surr.nbinom.null.id.taus[i] <- cor(sub1.surr.nbinom.null.id[[i]], t, method = "kendall")
  sub2.surr.nbinom.null.id.taus[i] <- cor(sub2.surr.nbinom.null.id[[i]], t, method = "kendall")
  sub3.surr.nbinom.null.id.taus[i] <- cor(sub3.surr.nbinom.null.id[[i]], t, method = "kendall")
  sub4.surr.nbinom.null.id.taus[i] <- cor(sub4.surr.nbinom.null.id[[i]], t, method = "kendall")
  sub5.surr.nbinom.null.id.taus[i] <- cor(sub5.surr.nbinom.null.id[[i]], t, method = "kendall")
  sub6.surr.nbinom.null.id.taus[i] <- cor(sub6.surr.nbinom.null.id[[i]], t, method = "kendall")
  sub7.surr.nbinom.null.id.taus[i] <- cor(sub7.surr.nbinom.null.id[[i]], t, method = "kendall")
  sub8.surr.nbinom.null.id.taus[i] <- cor(sub8.surr.nbinom.null.id[[i]], t, method = "kendall")
}
```
...
subpop <- c(rep("1", 1000), rep("2", 1000), rep("3", 1000), rep("4", 1000), rep("5", 1000), rep("6", 1000), rep("7", 1000), rep("8", 1000))
real.tau <- c(rep(sub1.mean.tau, 1000), rep(sub2.mean.tau, 1000), rep(sub3.mean.tau, 1000), rep(sub4.mean.tau, 1000), rep(sub5.mean.tau, 1000), rep(sub6.mean.tau, 1000), rep(sub7.mean.tau, 1000), rep(sub8.mean.tau, 1000))
null.mean.taus <- c(sub1.surr.nbinom.null.mean.taus, sub2.surr.nbinom.null.mean.taus, sub3.surr.nbinom.null.mean.taus, sub4.surr.nbinom.null.mean.taus, sub5.surr.nbinom.null.mean.taus, sub6.surr.nbinom.null.mean.taus, sub7.surr.nbinom.null.mean.taus, sub8.surr.nbinom.null.mean.taus)
null.mean.taus.df <- data.frame(
  subpop = subpop, 
  real.tau = real.tau,
  null.mean.taus = null.mean.taus
...
subpop <- c(rep("1", 1000), rep("2", 1000), rep("3", 1000), rep("4", 1000), rep("5", 1000), rep("6", 1000), rep("7", 1000), rep("8", 1000))
real.tau <- c(rep(sub1.var.tau, 1000), rep(sub2.var.tau, 1000), rep(sub3.var.tau, 1000), rep(sub4.var.tau, 1000), rep(sub5.var.tau, 1000), rep(sub6.var.tau, 1000), rep(sub7.var.tau, 1000), rep(sub8.var.tau, 1000))
null.var.taus <- c(sub1.surr.nbinom.null.var.taus, sub2.surr.nbinom.null.var.taus, sub3.surr.nbinom.null.var.taus, sub4.surr.nbinom.null.var.taus, sub5.surr.nbinom.null.var.taus, sub6.surr.nbinom.null.var.taus, sub7.surr.nbinom.null.var.taus, sub8.surr.nbinom.null.var.taus)
null.var.taus.df <- data.frame(
  subpop = subpop, 
  real.tau = real.tau,
  null.var.taus = null.var.taus
...
subpop <- c(rep("1", 1000), rep("2", 1000), rep("3", 1000), rep("4", 1000), rep("5", 1000), rep("6", 1000), rep("7", 1000), rep("8", 1000))
real.tau <- c(rep(sub1.id.tau, 1000), rep(sub2.id.tau, 1000), rep(sub3.id.tau, 1000), rep(sub4.id.tau, 1000), rep(sub5.id.tau, 1000), rep(sub6.id.tau, 1000), rep(sub7.id.tau, 1000), rep(sub8.id.tau, 1000))
null.id.taus <- c(sub1.surr.nbinom.null.id.taus, sub2.surr.nbinom.null.id.taus, sub3.surr.nbinom.null.id.taus, sub4.surr.nbinom.null.id.taus, sub5.surr.nbinom.null.id.taus, sub6.surr.nbinom.null.id.taus, sub7.surr.nbinom.null.id.taus, sub8.surr.nbinom.null.id.taus)
null.id.taus.df <- data.frame(
  subpop = subpop, 
  real.tau = real.tau,
  null.id.taus = null.id.taus
...
```{r}
## Mean
surr.nbinom.null.mean.taus <- list(
  sub1.surr.nbinom.null.mean.taus,
  sub2.surr.nbinom.null.mean.taus,
  sub3.surr.nbinom.null.mean.taus,
  sub4.surr.nbinom.null.mean.taus,
  sub5.surr.nbinom.null.mean.taus,
  sub6.surr.nbinom.null.mean.taus,
  sub7.surr.nbinom.null.mean.taus,
  sub8.surr.nbinom.null.mean.taus
)
cols <- c(rep("#A7C7E7", 4), rep("#F6799D", 4))
mains <- c("pop1.mean", "pop2.mean", "pop3.mean", "pop4.mean", "pop5.mean", "pop6.mean", "pop7.mean", "pop8.mean")
true.taus <- c(constant.mean.tau, warming.mean.tau)
...
par(mfrow = c(2, 4))
for (i in 1:8){
  hist(surr.nbinom.null.mean.taus[[i]], 
     col = cols[i], border = cols[i],
     xlim = c(-1, 1), ylim = c(1, 200),
     main = mains[i], xlab = "")
  abline(v = true.taus[i], col = vline.cols[i], lwd = 2)
...
## Variance
surr.nbinom.null.var.taus <- list(
  sub1.surr.nbinom.null.var.taus,
  sub2.surr.nbinom.null.var.taus,
  sub3.surr.nbinom.null.var.taus,
  sub4.surr.nbinom.null.var.taus,
  sub5.surr.nbinom.null.var.taus,
  sub6.surr.nbinom.null.var.taus,
  sub7.surr.nbinom.null.var.taus,
  sub8.surr.nbinom.null.var.taus
)
cols <- c(rep("#A7C7E7", 4), rep("#F6799D", 4))
mains <- c("pop1.var", "pop2.var", "pop3.var", "pop4.var", "pop5.var", "pop6.var", "pop7.var", "pop8.var")
true.taus <- c(constant.var.tau, warming.var.tau)
...
par(mfrow = c(2, 4))
for (i in 1:8){
  hist(surr.nbinom.null.var.taus[[i]], 
     col = cols[i], border = cols[i],
     xlim = c(-1, 1), ylim = c(1, 200),
     main = mains[i], xlab = "")
  abline(v = true.taus[i], col = vline.cols[i], lwd = 2)
...
## Index of Dispersion
surr.nbinom.null.id.taus <- list(
  sub1.surr.nbinom.null.id.taus,
  sub2.surr.nbinom.null.id.taus,
  sub3.surr.nbinom.null.id.taus,
  sub4.surr.nbinom.null.id.taus,
  sub5.surr.nbinom.null.id.taus,
  sub6.surr.nbinom.null.id.taus,
  sub7.surr.nbinom.null.id.taus,
  sub8.surr.nbinom.null.id.taus
)
cols <- c(rep("#A7C7E7", 4), rep("#F6799D", 4))
mains <- c("pop1.id", "pop2.id", "pop3.id", "pop4.id", "pop5.id", "pop6.id", "pop7.id", "pop8.id")
true.taus <- c(constant.id.tau, warming.id.tau)
...
par(mfrow = c(2, 4))
for (i in 1:8){
  hist(surr.nbinom.null.id.taus[[i]], 
     col = cols[i], border = cols[i],
     xlim = c(-1, 1), ylim = c(1, 200),
     main = mains[i], xlab = "")
  abline(v = true.taus[i], col = vline.cols[i], lwd = 2)
...
mean.p.vals <- c()
for (i in 1:8){
  mean.p.vals[i] <- length(which(surr.nbinom.null.mean.taus[[i]] >= true.taus[i]))/1000
}
...
var.nb.vals <- c()
for (i in 1:8){
  var.nb.vals[i] <- length(which(surr.nbinom.null.var.taus[[i]] >= true.taus[i]))/1000
}
...
id.p.vals <- c()
for (i in 1:8){
  id.p.vals[i] <- length(which(surr.nbinom.null.id.taus[[i]] >= true.taus[i]))/1000
}
...
ar.nb.mean.taus <- data.frame(subpops, null.mean.taus)
ar.nb.mean.taus.CIs <- c(); j = 1; k = 1000
for (i in 1:8){
  ar.nb.mean.taus.CIs[i] <- quantile(ar.nb.mean.taus[j:k, 2], probs = c(0.95), na.rm = TRUE)
  j = j + 1000; k = k + 1000
}

ar.nb.var.taus <- data.frame(subpops, null.var.taus)
ar.nb.var.taus.CIs <- c(); j = 1; k = 1000
for (i in 1:8){
  ar.nb.var.taus.CIs[i] <- quantile(ar.nb.var.taus[j:k, 2], probs = c(0.95), na.rm = TRUE)
  j = j + 1000; k = k + 1000
}

ar.nb.id.taus <- data.frame(subpops, null.id.taus)
ar.nb.id.taus.CIs <- c(); j = 1; k = 1000
for (i in 1:8){
  ar.nb.id.taus.CIs[i] <- quantile(ar.nb.id.taus[j:k, 2], probs = c(0.95), na.rm = TRUE)
  j = j + 1000; k = k + 1000
}

ar.nb.mean.pvals <- p.vals$mean
ar.nb.var.pvals <- p.vals$var
ar.nb.id.pvals <- p.vals$id
```
...
# Simulation
mu <- c(mu_start); # Time series for the mean of the auto-regressive process
y <- rnbinom(1, (exp(mu[i])^2 / sigma^2), (exp(mu[i]) / sigma^2)) # Start of prevalence time series
for(t in 2:TT){
	mu[t] <- ac*mu[t-1] + rnorm(1, 0, sigma) # Autoregressive part
	y[t] <- rnbinom(1, (exp(mu[t])^2 / sigma^2), (exp(mu[t]) / sigma^2)) # Prevalence count
}
...
# Comparing Poisson and Neg. Binom. Distributions

```{r}
which(ar.p.mean.pvals <= 0.055)
which(ar.nb.mean.pvals <= 0.055)

which(ar.p.var.pvals <= 0.055)
which(ar.nb.var.pvals <= 0.055)

which(ar.p.id.pvals <= 0.055)
which(ar.nb.id.pvals <= 0.055)
```

# (6) Surrogate Time Series via AR-2 Model
...
## AR(1)
sub1.ts.ac <- acf(sub1.ts, lag.max = 2, type = "correlation", plot = FALSE)[[1]][2:3]
sub2.ts.ac <- acf(sub2.ts, lag.max = 2, type = "correlation", plot = FALSE)[[1]][2:3] 
sub3.ts.ac <- acf(sub3.ts, lag.max = 2, type = "correlation", plot = FALSE)[[1]][2:3] 
sub4.ts.ac <- acf(sub4.ts, lag.max = 2, type = "correlation", plot = FALSE)[[1]][2:3] 
sub5.ts.ac <- acf(sub5.ts, lag.max = 2, type = "correlation", plot = FALSE)[[1]][2:3] 
sub6.ts.ac <- acf(sub6.ts, lag.max = 2, type = "correlation", plot = FALSE)[[1]][2:3] 
sub7.ts.ac <- acf(sub7.ts, lag.max = 2, type = "correlation", plot = FALSE)[[1]][2:3]
sub8.ts.ac <- acf(sub8.ts, lag.max = 2, type = "correlation", plot = FALSE)[[1]][2:3] 

## Function
AR2.func <- function(x.prev2, x.prev1, mu, v, ac2, ac1){
  
  delta <- mu*(1 - ac2 - ac1)
  
  sigma2 <- v*(1 - ac2^2 - ac1^2)
  
  omega <- rnorm(n = 1, mean = 0, sd = sigma2)
  
  x.next <- delta + ac2*x.prev2 + ac1*x.prev1 + omega
...
## Implementation
x.prev2 <- 0
set.seed(123); x.prev1 <- AR.func(x.prev = x.prev2, mu = sub1.ts.mean, v = sub1.ts.var, ac = sub1.ts.ac[1]) 
seed <- c(1:119)
surr.ts <- c(x.prev2, x.prev1)
for (i in 1:118){
  set.seed(seed[i])
  x.next <- AR2.func(x.prev2 = x.prev2, x.prev1 = x.prev1, mu = sub1.ts.mean, 
                    v = sub1.ts.var, ac2 = sub1.ts.ac[2], ac1 = sub1.ts.ac[1])
  surr.ts <- c(surr.ts, x.next)
  x.prev1 <- x.next
  x.prev2 <- x.prev1
}
...
## Get 1000 time series
ints <- c(1:(1000*118))
all.seeds <- matrix(ints, nrow = 118)
...
for (i in 1:1000){
  ...
  sub1.surr.ar2.df <- cbind(sub1.surr.ar2.df, surr.ts)
}
sub1.surr.ar2.df <- as.data.frame(sub1.surr.ar2.df[seq(3, 120, 3), ])

## Subpopulation 2
sub2.surr.ar2.df <- c()
for (i in 1:1000){
  x.prev2 <- 0
  set.seed(123); x.prev1 <- AR.func(x.prev = x.prev2, mu = sub2.ts.mean, v = sub2.ts.var, ac = sub2.ts.ac[1])
  seeds <- all.seeds[ , i]
  surr.ts <- c(x.prev2, x.prev1)
  for (j in 1:118){
    set.seed(seeds[j])
    x.next <- AR2.func(x.prev2 = x.prev2, x.prev1 = x.prev1, mu = sub2.ts.mean, 
                    v = sub2.ts.var, ac2 = sub2.ts.ac[2], ac1 = sub2.ts.ac[1])
    surr.ts <- c(surr.ts, x.next)
    x.prev1 <- x.next
    x.prev2 <- x.prev1
  }
  sub2.surr.ar2.df <- cbind(sub2.surr.ar2.df, surr.ts)
}
sub2.surr.ar2.df <- as.data.frame(sub2.surr.ar2.df[seq(3, 120, 3), ])

## Subpopulation 3
sub3.surr.ar2.df <- c()
for (i in 1:1000){
  x.prev2 <- 0
  set.seed(123); x.prev1 <- AR.func(x.prev = x.prev2, mu = sub3.ts.mean, v = sub3.ts.var, ac = sub3.ts.ac[1])
  seeds <- all.seeds[ , i]
  surr.ts <- c(x.prev2, x.prev1)
  for (j in 1:118){
    set.seed(seeds[j])
    x.next <- AR2.func(x.prev2 = x.prev2, x.prev1 = x.prev1, mu = sub3.ts.mean, 
                    v = sub3.ts.var, ac2 = sub3.ts.ac[2], ac1 = sub3.ts.ac[1])
    surr.ts <- c(surr.ts, x.next)
    x.prev1 <- x.next
    x.prev2 <- x.prev1
  }
  sub3.surr.ar2.df <- cbind(sub3.surr.ar2.df, surr.ts)
}
sub3.surr.ar2.df <- as.data.frame(sub3.surr.ar2.df[seq(3, 120, 3), ])

## Subpopulation 4
sub4.surr.ar2.df <- c()
for (i in 1:1000){
  x.prev2 <- 0
  set.seed(123); x.prev1 <- AR.func(x.prev = x.prev2, mu = sub4.ts.mean, v = sub4.ts.var, ac = sub4.ts.ac[1])
  seeds <- all.seeds[ , i]
  surr.ts <- c(x.prev2, x.prev1)
  for (j in 1:118){
    set.seed(seeds[j])
    x.next <- AR2.func(x.prev2 = x.prev2, x.prev1 = x.prev1, mu = sub4.ts.mean, 
                    v = sub4.ts.var, ac2 = sub4.ts.ac[2], ac1 = sub4.ts.ac[1])
    surr.ts <- c(surr.ts, x.next)
    x.prev1 <- x.next
    x.prev2 <- x.prev1
  }
  sub4.surr.ar2.df <- cbind(sub4.surr.ar2.df, surr.ts)
}
sub4.surr.ar2.df <- as.data.frame(sub4.surr.ar2.df[seq(3, 120, 3), ])

## Subpopulation 5
sub5.surr.ar2.df <- c()
for (i in 1:1000){
  x.prev2 <- 0
  set.seed(123); x.prev1 <- AR.func(x.prev = x.prev2, mu = sub5.ts.mean, v = sub5.ts.var, ac = sub5.ts.ac[1])
  seeds <- all.seeds[ , i]
  surr.ts <- c(x.prev2, x.prev1)
  for (j in 1:118){
    set.seed(seeds[j])
    x.next <- AR2.func(x.prev2 = x.prev2, x.prev1 = x.prev1, mu = sub5.ts.mean, 
                    v = sub5.ts.var, ac2 = sub5.ts.ac[2], ac1 = sub5.ts.ac[1])
    surr.ts <- c(surr.ts, x.next)
    x.prev1 <- x.next
    x.prev2 <- x.prev1
  }
  sub5.surr.ar2.df <- cbind(sub5.surr.ar2.df, surr.ts)
}
sub5.surr.ar2.df <- as.data.frame(sub5.surr.ar2.df[seq(3, 120, 3), ])

## Subpopulation 6
sub6.surr.ar2.df <- c()
for (i in 1:1000){
  x.prev2 <- 0
  set.seed(123); x.prev1 <- AR.func(x.prev = x.prev2, mu = sub6.ts.mean, v = sub6.ts.var, ac = sub6.ts.ac[1])
  seeds <- all.seeds[ , i]
  surr.ts <- c(x.prev2, x.prev1)
  for (j in 1:118){
    set.seed(seeds[j])
    x.next <- AR2.func(x.prev2 = x.prev2, x.prev1 = x.prev1, mu = sub6.ts.mean, 
                    v = sub6.ts.var, ac2 = sub6.ts.ac[2], ac1 = sub6.ts.ac[1])
    surr.ts <- c(surr.ts, x.next)
    x.prev1 <- x.next
    x.prev2 <- x.prev1
  }
  sub6.surr.ar2.df <- cbind(sub6.surr.ar2.df, surr.ts)
}
sub6.surr.ar2.df <- as.data.frame(sub6.surr.ar2.df[seq(3, 120, 3), ])

## Subpopulation 7
sub7.surr.ar2.df <- c()
for (i in 1:1000){
  x.prev2 <- 0
  set.seed(123); x.prev1 <- AR.func(x.prev = x.prev2, mu = sub7.ts.mean, v = sub7.ts.var, ac = sub7.ts.ac[1])
  seeds <- all.seeds[ , i]
  surr.ts <- c(x.prev2, x.prev1)
  for (j in 1:118){
    set.seed(seeds[j])
    x.next <- AR2.func(x.prev2 = x.prev2, x.prev1 = x.prev1, mu = sub7.ts.mean, 
                    v = sub7.ts.var, ac2 = sub7.ts.ac[2], ac1 = sub7.ts.ac[1])
    surr.ts <- c(surr.ts, x.next)
    x.prev1 <- x.next
    x.prev2 <- x.prev1
  }
  sub7.surr.ar2.df <- cbind(sub7.surr.ar2.df, surr.ts)
}
sub7.surr.ar2.df <- as.data.frame(sub7.surr.ar2.df[seq(3, 120, 3), ])

## Subpopulation 8
sub8.surr.ar2.df <- c()
for (i in 1:1000){
  x.prev2 <- 0
  set.seed(123); x.prev1 <- AR.func(x.prev = x.prev2, mu = sub8.ts.mean, v = sub8.ts.var, ac = sub8.ts.ac[1])
  seeds <- all.seeds[ , i]
  surr.ts <- c(x.prev2, x.prev1)
  for (j in 1:118){
    set.seed(seeds[j])
    x.next <- AR2.func(x.prev2 = x.prev2, x.prev1 = x.prev1, mu = sub8.ts.mean, 
                    v = sub8.ts.var, ac2 = sub8.ts.ac[2], ac1 = sub8.ts.ac[1])
    surr.ts <- c(surr.ts, x.next)
    x.prev1 <- x.next
    x.prev2 <- x.prev1
  }
  sub8.surr.ar2.df <- cbind(sub8.surr.ar2.df, surr.ts)
}
sub8.surr.ar2.df <- as.data.frame(sub8.surr.ar2.df[seq(3, 120, 3), ])
```

## Data Wrangling

```{r}
sub1.surr.ar2.null <- as.list(sub1.surr.ar2.df[1:20, ])
sub2.surr.ar2.null <- as.list(sub2.surr.ar2.df[1:20, ])
sub3.surr.ar2.null <- as.list(sub3.surr.ar2.df[1:20, ])
sub4.surr.ar2.null <- as.list(sub4.surr.ar2.df[1:20, ])
sub5.surr.ar2.null <- as.list(sub5.surr.ar2.df[1:20, ])
sub6.surr.ar2.null <- as.list(sub6.surr.ar2.df[1:20, ])
sub7.surr.ar2.null <- as.list(sub7.surr.ar2.df[1:20, ])
sub8.surr.ar2.null <- as.list(sub8.surr.ar2.df[1:20, ])
```
...
```{r}
sub1.surr.ar2.null.mean <- list(); sub1.surr.ar2.null.sd <- list()
sub2.surr.ar2.null.mean <- list(); sub2.surr.ar2.null.sd <- list()
sub3.surr.ar2.null.mean <- list(); sub3.surr.ar2.null.sd <- list()
sub4.surr.ar2.null.mean <- list(); sub4.surr.ar2.null.sd <- list()
sub5.surr.ar2.null.mean <- list(); sub5.surr.ar2.null.sd <- list()
sub6.surr.ar2.null.mean <- list(); sub6.surr.ar2.null.sd <- list()
sub7.surr.ar2.null.mean <- list(); sub7.surr.ar2.null.sd <- list()
sub8.surr.ar2.null.mean <- list(); sub8.surr.ar2.null.sd <- list()

for (i in 1:length(sub1.surr.ar2.null)){
  sub1.surr.ar2.null.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub1.surr.ar2.null[[i]], window = 5, step = 1)
  sub1.surr.ar2.null.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub1.surr.ar2.null[[i]], window = 5, step = 1)
  
  sub2.surr.ar2.null.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub2.surr.ar2.null[[i]], window = 5, step = 1)
  sub2.surr.ar2.null.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub2.surr.ar2.null[[i]], window = 5, step = 1)
  
  sub3.surr.ar2.null.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub3.surr.ar2.null[[i]], window = 5, step = 1)
  sub3.surr.ar2.null.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub3.surr.ar2.null[[i]], window = 5, step = 1)
  
  sub4.surr.ar2.null.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub4.surr.ar2.null[[i]], window = 5, step = 1)
  sub4.surr.ar2.null.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub4.surr.ar2.null[[i]], window = 5, step = 1)
  
  sub5.surr.ar2.null.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub5.surr.ar2.null[[i]], window = 5, step = 1)
  sub5.surr.ar2.null.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub5.surr.ar2.null[[i]], window = 5, step = 1)
  
  sub6.surr.ar2.null.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub6.surr.ar2.null[[i]], window = 5, step = 1)
  sub6.surr.ar2.null.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub6.surr.ar2.null[[i]], window = 5, step = 1)
  
  sub7.surr.ar2.null.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub7.surr.ar2.null[[i]], window = 5, step = 1)
  sub7.surr.ar2.null.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub7.surr.ar2.null[[i]], window = 5, step = 1)
  
  sub8.surr.ar2.null.mean[[i]] <- SlidingWindow(FUN = "mean", data = sub8.surr.ar2.null[[i]], window = 5, step = 1)
  sub8.surr.ar2.null.sd[[i]] <- SlidingWindow(FUN = "sd", data = sub8.surr.ar2.null[[i]], window = 5, step = 1)
}
```
...
```{r}
sub1.surr.ar2.null.var <- list(); sub2.surr.ar2.null.var <- list(); sub3.surr.ar2.null.var <- list(); sub4.surr.ar2.null.var <- list()
sub5.surr.ar2.null.var <- list(); sub6.surr.ar2.null.var <- list(); sub7.surr.ar2.null.var <- list(); sub8.surr.ar2.null.var <- list()
for (i in 1:1000){
  sub1.surr.ar2.null.var[[i]] <- sub1.surr.ar2.null.sd[[i]]^2
  sub2.surr.ar2.null.var[[i]] <- sub2.surr.ar2.null.sd[[i]]^2
  sub3.surr.ar2.null.var[[i]] <- sub3.surr.ar2.null.sd[[i]]^2
  sub4.surr.ar2.null.var[[i]] <- sub4.surr.ar2.null.sd[[i]]^2
  sub5.surr.ar2.null.var[[i]] <- sub5.surr.ar2.null.sd[[i]]^2
  sub6.surr.ar2.null.var[[i]] <- sub6.surr.ar2.null.sd[[i]]^2
  sub7.surr.ar2.null.var[[i]] <- sub7.surr.ar2.null.sd[[i]]^2
  sub8.surr.ar2.null.var[[i]] <- sub8.surr.ar2.null.sd[[i]]^2
}
```
...
```{r}
sub1.surr.ar2.null.id <- list(); sub2.surr.ar2.null.id <- list(); sub3.surr.ar2.null.id <- list(); sub4.surr.ar2.null.id <- list()
sub5.surr.ar2.null.id <- list(); sub6.surr.ar2.null.id <- list(); sub7.surr.ar2.null.id <- list(); sub8.surr.ar2.null.id <- list()
for (i in 1:1000){
  sub1.surr.ar2.null.id[[i]] <- sub1.surr.ar2.null.var[[i]]/(sub1.surr.ar2.null.mean[[i]] + 1e-10)
  sub2.surr.ar2.null.id[[i]] <- sub2.surr.ar2.null.var[[i]]/(sub2.surr.ar2.null.mean[[i]] + 1e-10)
  sub3.surr.ar2.null.id[[i]] <- sub3.surr.ar2.null.var[[i]]/(sub3.surr.ar2.null.mean[[i]] + 1e-10)
  sub4.surr.ar2.null.id[[i]] <- sub4.surr.ar2.null.var[[i]]/(sub4.surr.ar2.null.mean[[i]] + 1e-10)
  sub5.surr.ar2.null.id[[i]] <- sub5.surr.ar2.null.var[[i]]/(sub5.surr.ar2.null.mean[[i]] + 1e-10)
  sub6.surr.ar2.null.id[[i]] <- sub6.surr.ar2.null.var[[i]]/(sub6.surr.ar2.null.mean[[i]] + 1e-10)
  sub7.surr.ar2.null.id[[i]] <- sub7.surr.ar2.null.var[[i]]/(sub7.surr.ar2.null.mean[[i]] + 1e-10)
  sub8.surr.ar2.null.id[[i]] <- sub8.surr.ar2.null.var[[i]]/(sub8.surr.ar2.null.mean[[i]] + 1e-10)
}
```
...
```{r}
sub1.surr.ar2.null.mean.taus <- c(); sub2.surr.ar2.null.mean.taus <- c(); sub3.surr.ar2.null.mean.taus <- c(); sub4.surr.ar2.null.mean.taus <- c()
sub5.surr.ar2.null.mean.taus <- c(); sub6.surr.ar2.null.mean.taus <- c(); sub7.surr.ar2.null.mean.taus <- c(); sub8.surr.ar2.null.mean.taus <- c()
t <- seq(1, 15, 1)
for (i in 1:1000){
  sub1.surr.ar2.null.mean.taus[i] <- cor(sub1.surr.ar2.null.mean[[i]], t, method = "kendall")
  sub2.surr.ar2.null.mean.taus[i] <- cor(sub2.surr.ar2.null.mean[[i]], t, method = "kendall")
  sub3.surr.ar2.null.mean.taus[i] <- cor(sub3.surr.ar2.null.mean[[i]], t, method = "kendall")
  sub4.surr.ar2.null.mean.taus[i] <- cor(sub4.surr.ar2.null.mean[[i]], t, method = "kendall")
  sub5.surr.ar2.null.mean.taus[i] <- cor(sub5.surr.ar2.null.mean[[i]], t, method = "kendall")
  sub6.surr.ar2.null.mean.taus[i] <- cor(sub6.surr.ar2.null.mean[[i]], t, method = "kendall")
  sub7.surr.ar2.null.mean.taus[i] <- cor(sub7.surr.ar2.null.mean[[i]], t, method = "kendall")
  sub8.surr.ar2.null.mean.taus[i] <- cor(sub8.surr.ar2.null.mean[[i]], t, method = "kendall")
}
```
...
```{r}
sub1.surr.ar2.null.var.taus <- c(); sub2.surr.ar2.null.var.taus <- c(); sub3.surr.ar2.null.var.taus <- c(); sub4.surr.ar2.null.var.taus <- c()
sub5.surr.ar2.null.var.taus <- c(); sub6.surr.ar2.null.var.taus <- c(); sub7.surr.ar2.null.var.taus <- c(); sub8.surr.ar2.null.var.taus <- c()
t <- seq(1, 15, 1)
for (i in 1:1000){
  sub1.surr.ar2.null.var.taus[i] <- cor(sub1.surr.ar2.null.var[[i]], t, method = "kendall")
  sub2.surr.ar2.null.var.taus[i] <- cor(sub2.surr.ar2.null.var[[i]], t, method = "kendall")
  sub3.surr.ar2.null.var.taus[i] <- cor(sub3.surr.ar2.null.var[[i]], t, method = "kendall")
  sub4.surr.ar2.null.var.taus[i] <- cor(sub4.surr.ar2.null.var[[i]], t, method = "kendall")
  sub5.surr.ar2.null.var.taus[i] <- cor(sub5.surr.ar2.null.var[[i]], t, method = "kendall")
  sub6.surr.ar2.null.var.taus[i] <- cor(sub6.surr.ar2.null.var[[i]], t, method = "kendall")
  sub7.surr.ar2.null.var.taus[i] <- cor(sub7.surr.ar2.null.var[[i]], t, method = "kendall")
  sub8.surr.ar2.null.var.taus[i] <- cor(sub8.surr.ar2.null.var[[i]], t, method = "kendall")
}
```
...
```{r}
sub1.surr.ar2.null.id.taus <- c(); sub2.surr.ar2.null.id.taus <- c(); sub3.surr.ar2.null.id.taus <- c(); sub4.surr.ar2.null.id.taus <- c()
sub5.surr.ar2.null.id.taus <- c(); sub6.surr.ar2.null.id.taus <- c(); sub7.surr.ar2.null.id.taus <- c(); sub8.surr.ar2.null.id.taus <- c()
t <- seq(1, 15, 1)
for (i in 1:1000){
  sub1.surr.ar2.null.id.taus[i] <- cor(sub1.surr.ar2.null.id[[i]], t, method = "kendall")
  sub2.surr.ar2.null.id.taus[i] <- cor(sub2.surr.ar2.null.id[[i]], t, method = "kendall")
  sub3.surr.ar2.null.id.taus[i] <- cor(sub3.surr.ar2.null.id[[i]], t, method = "kendall")
  sub4.surr.ar2.null.id.taus[i] <- cor(sub4.surr.ar2.null.id[[i]], t, method = "kendall")
  sub5.surr.ar2.null.id.taus[i] <- cor(sub5.surr.ar2.null.id[[i]], t, method = "kendall")
  sub6.surr.ar2.null.id.taus[i] <- cor(sub6.surr.ar2.null.id[[i]], t, method = "kendall")
  sub7.surr.ar2.null.id.taus[i] <- cor(sub7.surr.ar2.null.id[[i]], t, method = "kendall")
  sub8.surr.ar2.null.id.taus[i] <- cor(sub8.surr.ar2.null.id[[i]], t, method = "kendall")
}
```
...
subpop <- c(rep("1", 1000), rep("2", 1000), rep("3", 1000), rep("4", 1000), rep("5", 1000), rep("6", 1000), rep("7", 1000), rep("8", 1000))
real.tau <- c(rep(sub1.mean.tau, 1000), rep(sub2.mean.tau, 1000), rep(sub3.mean.tau, 1000), rep(sub4.mean.tau, 1000), rep(sub5.mean.tau, 1000), rep(sub6.mean.tau, 1000), rep(sub7.mean.tau, 1000), rep(sub8.mean.tau, 1000))
null.mean.taus <- c(sub1.surr.ar2.null.mean.taus, sub2.surr.ar2.null.mean.taus, sub3.surr.ar2.null.mean.taus, sub4.surr.ar2.null.mean.taus, sub5.surr.ar2.null.mean.taus, sub6.surr.ar2.null.mean.taus, sub7.surr.ar2.null.mean.taus, sub8.surr.ar2.null.mean.taus)
null.mean.taus.df <- data.frame(
  subpop = subpop, 
  real.tau = real.tau,
  null.mean.taus = null.mean.taus
...
subpop <- c(rep("1", 1000), rep("2", 1000), rep("3", 1000), rep("4", 1000), rep("5", 1000), rep("6", 1000), rep("7", 1000), rep("8", 1000))
real.tau <- c(rep(sub1.var.tau, 1000), rep(sub2.var.tau, 1000), rep(sub3.var.tau, 1000), rep(sub4.var.tau, 1000), rep(sub5.var.tau, 1000), rep(sub6.var.tau, 1000), rep(sub7.var.tau, 1000), rep(sub8.var.tau, 1000))
null.var.taus <- c(sub1.surr.ar2.null.var.taus, sub2.surr.ar2.null.var.taus, sub3.surr.ar2.null.var.taus, sub4.surr.ar2.null.var.taus, sub5.surr.ar2.null.var.taus, sub6.surr.ar2.null.var.taus, sub7.surr.ar2.null.var.taus, sub8.surr.ar2.null.var.taus)
null.var.taus.df <- data.frame(
  subpop = subpop, 
  real.tau = real.tau,
  null.var.taus = null.var.taus
...
subpop <- c(rep("1", 1000), rep("2", 1000), rep("3", 1000), rep("4", 1000), rep("5", 1000), rep("6", 1000), rep("7", 1000), rep("8", 1000))
real.tau <- c(rep(sub1.id.tau, 1000), rep(sub2.id.tau, 1000), rep(sub3.id.tau, 1000), rep(sub4.id.tau, 1000), rep(sub5.id.tau, 1000), rep(sub6.id.tau, 1000), rep(sub7.id.tau, 1000), rep(sub8.id.tau, 1000))
null.id.taus <- c(sub1.surr.ar2.null.id.taus, sub2.surr.ar2.null.id.taus, sub3.surr.ar2.null.id.taus, sub4.surr.ar2.null.id.taus, sub5.surr.ar2.null.id.taus, sub6.surr.ar2.null.id.taus, sub7.surr.ar2.null.id.taus, sub8.surr.ar2.null.id.taus)
null.id.taus.df <- data.frame(
  subpop = subpop, 
  real.tau = real.tau,
  null.id.taus = null.id.taus
...
```{r}
## Mean
surr.ar2.null.mean.taus <- list(
  sub1.surr.ar2.null.mean.taus,
  sub2.surr.ar2.null.mean.taus,
  sub3.surr.ar2.null.mean.taus,
  sub4.surr.ar2.null.mean.taus,
  sub5.surr.ar2.null.mean.taus,
  sub6.surr.ar2.null.mean.taus,
  sub7.surr.ar2.null.mean.taus,
  sub8.surr.ar2.null.mean.taus
)
cols <- c(rep("#A7C7E7", 4), rep("#F6799D", 4))
mains <- c("pop1.mean", "pop2.mean", "pop3.mean", "pop4.mean", "pop5.mean", "pop6.mean", "pop7.mean", "pop8.mean")
true.taus <- c(constant.mean.tau, warming.mean.tau)
...
par(mfrow = c(2, 4))
for (i in 1:8){
  hist(surr.ar2.null.mean.taus[[i]], 
     col = cols[i], border = cols[i],
     xlim = c(-1, 1), ylim = c(1, 200),
     main = mains[i], xlab = "")
  abline(v = true.taus[i], col = vline.cols[i], lwd = 2)
...
## Variance
surr.ar2.null.var.taus <- list(
  sub1.surr.ar2.null.var.taus,
  sub2.surr.ar2.null.var.taus,
  sub3.surr.ar2.null.var.taus,
  sub4.surr.ar2.null.var.taus,
  sub5.surr.ar2.null.var.taus,
  sub6.surr.ar2.null.var.taus,
  sub7.surr.ar2.null.var.taus,
  sub8.surr.ar2.null.var.taus
)
cols <- c(rep("#A7C7E7", 4), rep("#F6799D", 4))
mains <- c("pop1.var", "pop2.var", "pop3.var", "pop4.var", "pop5.var", "pop6.var", "pop7.var", "pop8.var")
true.taus <- c(constant.var.tau, warming.var.tau)
...
## Index of Dispersion
surr.ar2.null.id.taus <- list(
  sub1.surr.ar2.null.id.taus,
  sub2.surr.ar2.null.id.taus,
  sub3.surr.ar2.null.id.taus,
  sub4.surr.ar2.null.id.taus,
  sub5.surr.ar2.null.id.taus,
  sub6.surr.ar2.null.id.taus,
  sub7.surr.ar2.null.id.taus,
  sub8.surr.ar2.null.id.taus
)
cols <- c(rep("#A7C7E7", 4), rep("#F6799D", 4))
mains <- c("pop1.id", "pop2.id", "pop3.id", "pop4.id", "pop5.id", "pop6.id", "pop7.id", "pop8.id")
true.taus <- c(constant.id.tau, warming.id.tau)
...
mean.p.vals <- c()
for (i in 1:8){
  mean.p.vals[i] <- length(which(surr.ar2.null.mean.taus[[i]] >= true.taus[i]))/1000
}
...
var.p.vals <- c()
for (i in 1:8){
  var.p.vals[i] <- length(which(surr.ar2.null.var.taus[[i]] >= true.taus[i]))/1000
}
...
id.p.vals <- c()
for (i in 1:8){
  id.p.vals[i] <- length(which(surr.ar2.null.id.taus[[i]] >= true.taus[i]))/1000
}
...
x.labs <- c("Mean", "Variance", "Index of Dispersion")
plot(x = 1, type = "n", xaxt = "n", yaxt = "n", 
     main = "P-Values Per Surrogate Time Series (AR(2) Model)", xlab = "", ylab = "P-Value",
     xlim = c(1, 3), ylim = c(0, 1))
text(1:3, p.vals[1, ], label = 1, col = alpha("#1434A4", 0.5))
text(1:3, p.vals[2, ], label = 2, col = alpha("#1434A4", 0.5))
text(1:3, p.vals[3, ], label = 3, col = alpha("#1434A4", 0.5))
...
ar2.mean.taus <- data.frame(subpops, null.mean.taus)
ar2.mean.taus.CIs <- c(); j = 1; k = 1000
for (i in 1:8){
  ar2.mean.taus.CIs[i] <- quantile(ar2.mean.taus[j:k, 2], probs = c(0.95), na.rm = TRUE)
  j = j + 1000; k = k + 1000
}

ar2.var.taus <- data.frame(subpops, null.var.taus)
ar2.var.taus.CIs <- c(); j = 1; k = 1000
for (i in 1:8){
  ar2.var.taus.CIs[i] <- quantile(ar2.var.taus[j:k, 2], probs = c(0.95), na.rm = TRUE)
  j = j + 1000; k = k + 1000
}

ar2.id.taus <- data.frame(subpops, null.id.taus)
ar2.id.taus.CIs <- c(); j = 1; k = 1000
for (i in 1:8){
  ar2.id.taus.CIs[i] <- quantile(ar2.id.taus[j:k, 2], probs = c(0.95), na.rm = TRUE)
  j = j + 1000; k = k + 1000
}

ar2.mean.pvals <- p.vals$mean
ar2.var.pvals <- p.vals$var
ar2.id.pvals <- p.vals$id
```

## Comparing AR-1 and AR-2 Processes

```{r}
which(ar.mean.pvals <= 0.055)
which(ar2.mean.pvals <= 0.055)
...
# (7) AR-2 Process with Poisson Distribution
...
```{r}
model <- stan_model("StanModels/10_SigTesting_AR2-Pois.stan")
```
