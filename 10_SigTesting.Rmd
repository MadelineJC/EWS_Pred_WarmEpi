...
# (4) AR Process with Poisson Distribution
...
# (5) AR Process with Negative Binomial Distribution

## Compiling Model

```{r}
model <- stan_model("10_SigTesting_NegBinom.stan")
```
