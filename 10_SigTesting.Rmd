...
## Mean, variance
sub1.ts.mean <- mean(sub1.ts); sub1.ts.var <- var(sub1.ts)
sub2.ts.mean <- mean(sub2.ts); sub2.ts.var <- var(sub2.ts)
sub3.ts.mean <- mean(sub3.ts); sub3.ts.var <- var(sub3.ts)
sub4.ts.mean <- mean(sub4.ts); sub4.ts.var <- var(sub4.ts)
sub5.ts.mean <- mean(sub5.ts); sub5.ts.var <- var(sub5.ts)
sub6.ts.mean <- mean(sub6.ts); sub6.ts.var <- var(sub6.ts)
sub7.ts.mean <- mean(sub7.ts); sub7.ts.var <- var(sub7.ts)
sub8.ts.mean <- mean(sub8.ts); sub8.ts.var <- var(sub8.ts)
