...
Okay, to determine this, we're going to (1) Add small, random values to every data point, and (2) re-calculate all AUC. We're going to do this a few times, with different sets of small, random values.
...
## Skewness
pop1.skewness <- SlidingWindow(FUN = "skewness", data = sub1.mod.1, window = 5, step = 1)
pop2.skewness <- SlidingWindow(FUN = "skewness", data = sub2.mod.1, window = 5, step = 1)
pop3.skewness <- SlidingWindow(FUN = "skewness", data = sub3.mod.1, window = 5, step = 1)
pop4.skewness <- SlidingWindow(FUN = "skewness", data = sub4.mod.1, window = 5, step = 1)
pop5.skewness <- SlidingWindow(FUN = "skewness", data = sub5.mod.1, window = 5, step = 1)
pop6.skewness <- SlidingWindow(FUN = "skewness", data = sub6.mod.1, window = 5, step = 1)
pop7.skewness <- SlidingWindow(FUN = "skewness", data = sub7.mod.1, window = 5, step = 1)
pop8.skewness <- SlidingWindow(FUN = "skewness", data = sub8.mod.1, window = 5, step = 1)
## Kurtosis
pop1.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub1.mod.1, window = 5, step = 1)
pop2.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub2.mod.1, window = 5, step = 1)
pop3.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub3.mod.1, window = 5, step = 1)
pop4.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub4.mod.1, window = 5, step = 1)
pop5.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub5.mod.1, window = 5, step = 1)
pop6.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub6.mod.1, window = 5, step = 1)
pop7.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub7.mod.1, window = 5, step = 1)
pop8.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub8.mod.1, window = 5, step = 1)
## Variation
pop1.var <- pop1.sd^2
pop2.var <- pop2.sd^2
pop3.var <- pop3.sd^2
...
## Skewness
pop1.skewness <- SlidingWindow(FUN = "skewness", data = sub1.mod.2, window = 5, step = 1)
pop2.skewness <- SlidingWindow(FUN = "skewness", data = sub2.mod.2, window = 5, step = 1)
pop3.skewness <- SlidingWindow(FUN = "skewness", data = sub3.mod.2, window = 5, step = 1)
pop4.skewness <- SlidingWindow(FUN = "skewness", data = sub4.mod.2, window = 5, step = 1)
pop5.skewness <- SlidingWindow(FUN = "skewness", data = sub5.mod.2, window = 5, step = 1)
pop6.skewness <- SlidingWindow(FUN = "skewness", data = sub6.mod.2, window = 5, step = 1)
pop7.skewness <- SlidingWindow(FUN = "skewness", data = sub7.mod.2, window = 5, step = 1)
pop8.skewness <- SlidingWindow(FUN = "skewness", data = sub8.mod.2, window = 5, step = 1)
## Kurtosis
pop1.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub1.mod.2, window = 5, step = 1)
pop2.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub2.mod.2, window = 5, step = 1)
pop3.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub3.mod.2, window = 5, step = 1)
pop4.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub4.mod.2, window = 5, step = 1)
pop5.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub5.mod.2, window = 5, step = 1)
pop6.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub6.mod.2, window = 5, step = 1)
pop7.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub7.mod.2, window = 5, step = 1)
pop8.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub8.mod.2, window = 5, step = 1)
## Variation
pop1.var <- pop1.sd^2
pop2.var <- pop2.sd^2
pop3.var <- pop3.sd^2
...
## Skewness
pop1.skewness <- SlidingWindow(FUN = "skewness", data = sub1.mod.3, window = 5, step = 1)
pop2.skewness <- SlidingWindow(FUN = "skewness", data = sub2.mod.3, window = 5, step = 1)
pop3.skewness <- SlidingWindow(FUN = "skewness", data = sub3.mod.3, window = 5, step = 1)
pop4.skewness <- SlidingWindow(FUN = "skewness", data = sub4.mod.3, window = 5, step = 1)
pop5.skewness <- SlidingWindow(FUN = "skewness", data = sub5.mod.3, window = 5, step = 1)
pop6.skewness <- SlidingWindow(FUN = "skewness", data = sub6.mod.3, window = 5, step = 1)
pop7.skewness <- SlidingWindow(FUN = "skewness", data = sub7.mod.3, window = 5, step = 1)
pop8.skewness <- SlidingWindow(FUN = "skewness", data = sub8.mod.3, window = 5, step = 1)
## Kurtosis
pop1.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub1.mod.3, window = 5, step = 1)
pop2.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub2.mod.3, window = 5, step = 1)
pop3.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub3.mod.3, window = 5, step = 1)
pop4.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub4.mod.3, window = 5, step = 1)
pop5.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub5.mod.3, window = 5, step = 1)
pop6.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub6.mod.3, window = 5, step = 1)
pop7.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub7.mod.3, window = 5, step = 1)
pop8.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub8.mod.3, window = 5, step = 1)
## Variation
pop1.var <- pop1.sd^2
pop2.var <- pop2.sd^2
pop3.var <- pop3.sd^2
...
## Skewness
pop1.skewness <- SlidingWindow(FUN = "skewness", data = sub1.mod.4, window = 5, step = 1)
pop2.skewness <- SlidingWindow(FUN = "skewness", data = sub2.mod.4, window = 5, step = 1)
pop3.skewness <- SlidingWindow(FUN = "skewness", data = sub3.mod.4, window = 5, step = 1)
pop4.skewness <- SlidingWindow(FUN = "skewness", data = sub4.mod.4, window = 5, step = 1)
pop5.skewness <- SlidingWindow(FUN = "skewness", data = sub5.mod.4, window = 5, step = 1)
pop6.skewness <- SlidingWindow(FUN = "skewness", data = sub6.mod.4, window = 5, step = 1)
pop7.skewness <- SlidingWindow(FUN = "skewness", data = sub7.mod.4, window = 5, step = 1)
pop8.skewness <- SlidingWindow(FUN = "skewness", data = sub8.mod.4, window = 5, step = 1)
## Kurtosis
pop1.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub1.mod.4, window = 5, step = 1)
pop2.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub2.mod.4, window = 5, step = 1)
pop3.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub3.mod.4, window = 5, step = 1)
pop4.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub4.mod.4, window = 5, step = 1)
pop5.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub5.mod.4, window = 5, step = 1)
pop6.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub6.mod.4, window = 5, step = 1)
pop7.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub7.mod.4, window = 5, step = 1)
pop8.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub8.mod.4, window = 5, step = 1)
## Variation
pop1.var <- pop1.sd^2
pop2.var <- pop2.sd^2
pop3.var <- pop3.sd^2
...
## Skewness
pop1.skewness <- SlidingWindow(FUN = "skewness", data = sub1.mod.5, window = 5, step = 1)
pop2.skewness <- SlidingWindow(FUN = "skewness", data = sub2.mod.5, window = 5, step = 1)
pop3.skewness <- SlidingWindow(FUN = "skewness", data = sub3.mod.5, window = 5, step = 1)
pop4.skewness <- SlidingWindow(FUN = "skewness", data = sub4.mod.5, window = 5, step = 1)
pop5.skewness <- SlidingWindow(FUN = "skewness", data = sub5.mod.5, window = 5, step = 1)
pop6.skewness <- SlidingWindow(FUN = "skewness", data = sub6.mod.5, window = 5, step = 1)
pop7.skewness <- SlidingWindow(FUN = "skewness", data = sub7.mod.5, window = 5, step = 1)
pop8.skewness <- SlidingWindow(FUN = "skewness", data = sub8.mod.5, window = 5, step = 1)
## Kurtosis
pop1.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub1.mod.5, window = 5, step = 1)
pop2.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub2.mod.5, window = 5, step = 1)
pop3.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub3.mod.5, window = 5, step = 1)
pop4.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub4.mod.5, window = 5, step = 1)
pop5.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub5.mod.5, window = 5, step = 1)
pop6.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub6.mod.5, window = 5, step = 1)
pop7.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub7.mod.5, window = 5, step = 1)
pop8.kurtosis <- SlidingWindow(FUN = "kurtosis", data = sub8.mod.5, window = 5, step = 1)
## Variation
pop1.var <- pop1.sd^2
pop2.var <- pop2.sd^2
pop3.var <- pop3.sd^2
