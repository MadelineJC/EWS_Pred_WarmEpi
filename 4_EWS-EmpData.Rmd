...
AUC_skewness_data <- calc_auc(warming.skewness.tau_without5, constant.skewness.tau); AUC_skewness_data
AUC_kurtosis_data <- calc_auc(warming.kurtosis.tau_without5, constant.kurtosis.tau); AUC_kurtosis_data
AUC_variance_data <- calc_auc(warming.variance.tau_without5, constant.variance.tau); AUC_variance_data
...
AUC_first.diff.variance_data <- calc_auc(warming.first.diff.variance.tau_without5, constant.first.diff.variance.tau); AUC_first.diff.variance_data
AUC_ac_data <- calc_auc(warming.ac.tau_without5, constant.ac.tau); AUC_ac_data
AUC_cov_data <- calc_auc(warming.cov.tau_without5, constant.cov.tau); AUC_cov_data
AUC_data <- c(AUC_mean_data, 
              AUC_skewness_data, 
              AUC_kurtosis_data, 
              AUC_variance_data,
