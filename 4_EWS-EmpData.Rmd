...
# 6 Day Sliding Window

## Calculating Statistical Metrics

```{r}
## Standard deviation
pop1.sd <- SlidingWindow(FUN = "sd", data = sub1$status.sum, window = 2, step = 1)
pop2.sd <- SlidingWindow(FUN = "sd", data = sub2$status.sum, window = 2, step = 1)
pop3.sd <- SlidingWindow(FUN = "sd", data = sub3$status.sum, window = 2, step = 1)
pop4.sd <- SlidingWindow(FUN = "sd", data = sub4$status.sum, window = 2, step = 1)
pop5.sd <- SlidingWindow(FUN = "sd", data = sub5$status.sum, window = 2, step = 1)
pop6.sd <- SlidingWindow(FUN = "sd", data = sub6$status.sum, window = 2, step = 1)
pop7.sd <- SlidingWindow(FUN = "sd", data = sub7$status.sum, window = 2, step = 1)
pop8.sd <- SlidingWindow(FUN = "sd", data = sub8$status.sum, window = 2, step = 1)

## Mean
pop1.mean <- SlidingWindow(FUN = "mean", data = sub1$status.sum, window = 2, step = 1)
pop2.mean <- SlidingWindow(FUN = "mean", data = sub2$status.sum, window = 2, step = 1)
pop3.mean <- SlidingWindow(FUN = "mean", data = sub3$status.sum, window = 2, step = 1)
pop4.mean <- SlidingWindow(FUN = "mean", data = sub4$status.sum, window = 2, step = 1)
pop5.mean <- SlidingWindow(FUN = "mean", data = sub5$status.sum, window = 2, step = 1)
pop6.mean <- SlidingWindow(FUN = "mean", data = sub6$status.sum, window = 2, step = 1)
pop7.mean <- SlidingWindow(FUN = "mean", data = sub7$status.sum, window = 2, step = 1)
pop8.mean <- SlidingWindow(FUN = "mean", data = sub8$status.sum, window = 2, step = 1)

## Skewness
pop1.sk <- SlidingWindow(FUN = "skewness", data = sub1$status.sum, window = 2, step = 1)
pop2.sk <- SlidingWindow(FUN = "skewness", data = sub2$status.sum, window = 2, step = 1)
pop3.sk <- SlidingWindow(FUN = "skewness", data = sub3$status.sum, window = 2, step = 1)
pop4.sk <- SlidingWindow(FUN = "skewness", data = sub4$status.sum, window = 2, step = 1)
pop5.sk <- SlidingWindow(FUN = "skewness", data = sub5$status.sum, window = 2, step = 1)
pop6.sk <- SlidingWindow(FUN = "skewness", data = sub6$status.sum, window = 2, step = 1)
pop7.sk <- SlidingWindow(FUN = "skewness", data = sub7$status.sum, window = 2, step = 1)
pop8.sk <- SlidingWindow(FUN = "skewness", data = sub8$status.sum, window = 2, step = 1)

## Kurtosis
pop1.kt <- SlidingWindow(FUN = "kurtosis", data = sub1$status.sum, window = 2, step = 1)
pop2.kt <- SlidingWindow(FUN = "kurtosis", data = sub2$status.sum, window = 2, step = 1)
pop3.kt <- SlidingWindow(FUN = "kurtosis", data = sub3$status.sum, window = 2, step = 1)
pop4.kt <- SlidingWindow(FUN = "kurtosis", data = sub4$status.sum, window = 2, step = 1)
pop5.kt <- SlidingWindow(FUN = "kurtosis", data = sub5$status.sum, window = 2, step = 1)
pop6.kt <- SlidingWindow(FUN = "kurtosis", data = sub6$status.sum, window = 2, step = 1)
pop7.kt <- SlidingWindow(FUN = "kurtosis", data = sub7$status.sum, window = 2, step = 1)
pop8.kt <- SlidingWindow(FUN = "kurtosis", data = sub8$status.sum, window = 2, step = 1)
```
...
constant.mean.tau.6 <- c(cor(pop1.mean[1:18], time.6, method = "kendall"), cor(pop2.mean[1:18], time.6, method = "kendall"),
                      cor(pop3.mean[1:18], time.6, method = "kendall"), cor(pop4.mean[1:18], time.6, method = "kendall"))
warming.mean.tau.6 <- c(cor(pop5.mean[1:18], time.6, method = "kendall"), cor(pop6.mean[1:18], time.6, method = "kendall"),
                      cor(pop7.mean[1:18], time.6, method = "kendall"), cor(pop8.mean[1:18], time.6, method = "kendall"))

constant.sk.tau.6 <- c(cor(pop1.sk[1:18], time.6, method = "kendall"), cor(pop2.sk[1:18], time.6, method = "kendall"),
                          cor(pop3.sk[1:18], time.6, method = "kendall"), cor(pop4.sk[1:18], time.6, method = "kendall"))
warming.sk.tau.6 <- c(cor(pop5.sk[1:18], time.6, method = "kendall"), cor(pop6.sk[1:18], time.6, method = "kendall"),
                          cor(pop7.sk[1:18], time.6, method = "kendall"), cor(pop8.sk[1:18], time.6, method = "kendall"))

constant.kt.tau.6 <- c(cor(pop1.kt[1:18], time.6, method = "kendall"), cor(pop2.kt[1:18], time.6, method = "kendall"),
                          cor(pop3.kt[1:18], time.6, method = "kendall"), cor(pop4.kt[1:18], time.6, method = "kendall"))
warming.kt.tau.6 <- c(cor(pop5.kt[1:18], time.6, method = "kendall"), cor(pop6.kt[1:18], time.6, method = "kendall"),
                          cor(pop7.kt[1:18], time.6, method = "kendall"), cor(pop8.kt[1:18], time.6, method = "kendall"))

constant.var.tau.6 <- c(cor(pop1.var[1:18], time.6, method = "kendall"), cor(pop2.var[1:18], time.6, method = "kendall"),
                          cor(pop3.var[1:18], time.6, method = "kendall"), cor(pop4.var[1:18], time.6, method = "kendall"))
warming.var.tau.6<- c(cor(pop5.var[1:18], time.6, method = "kendall"), cor(pop6.var[1:18], time.6, method = "kendall"),
                         cor(pop7.var[1:18], time.6, method = "kendall"), cor(pop8.var[1:18], time.6, method = "kendall"))

constant.cv.tau.6 <- c(cor(pop1.cv[1:18], time.6, method = "kendall"), cor(pop2.cv[1:18], time.6, method = "kendall"),
                    cor(pop3.cv[1:18], time.6, method = "kendall"), cor(pop4.cv[1:18], time.6, method = "kendall"))
warming.cv.tau.6 <- c(cor(pop5.cv[1:18], time.6, method = "kendall"), cor(pop6.cv[1:18], time.6, method = "kendall"),
                    cor(pop7.cv[1:18], time.6, method = "kendall"), cor(pop8.cv[1:18], time.6, method = "kendall"))

constant.id.tau.6 <- c(cor(pop1.id[1:18], time.6, method = "kendall"), cor(pop2.id[1:18], time.6, method = "kendall"),
                    cor(pop3.id[1:18], time.6, method = "kendall"), cor(pop4.id[1:18], time.6, method = "kendall"))
warming.id.tau.6 <- c(cor(pop5.id[1:18], time.6, method = "kendall"), cor(pop6.id[1:18], time.6, method = "kendall"),
                    cor(pop7.id[1:18], time.6, method = "kendall"), cor(pop8.id[1:18], time.6, method = "kendall"))

constant.fdv.tau.6 <- c(cor(pop1.fdv[1:18], time.6, method = "kendall"), cor(pop2.fdv[1:18], time.6, method = "kendall"),
                                     cor(pop3.fdv[1:18], time.6, method = "kendall"), cor(pop4.fdv[1:18], time.6, method = "kendall"))
warming.fdv.tau.6 <- c(cor(pop5.fdv[1:18], time.6, method = "kendall"), cor(pop6.fdv[1:18], time.6, method = "kendall"),
                                     cor(pop7.fdv[1:18], time.6, method = "kendall"), cor(pop8.fdv[1:18], time.6, method = "kendall"))

constant.ac.tau.6 <- c(cor(pop1.ac[1:18], time.6, method = "kendall"), cor(pop2.ac[1:18], time.6, method = "kendall"),
                    cor(pop3.ac[1:18], time.6, method = "kendall"), cor(pop4.ac[1:18], time.6, method = "kendall"))
warming.ac.tau.6 <- c(cor(pop5.ac[1:18], time.6, method = "kendall"), cor(pop6.ac[1:18], time.6, method = "kendall"),
                    cor(pop7.ac[1:18], time.6, method = "kendall"), cor(pop8.ac[1:18], time.6, method = "kendall"))

constant.acv.tau.6 <- c(cor(pop1.acv[1:18], time.6, method = "kendall"), cor(pop2.acv[1:18], time.6, method = "kendall"),
                     cor(pop3.acv[1:18], time.6, method = "kendall"), cor(pop4.acv[1:18], time.6, method = "kendall"))
warming.acv.tau.6 <- c(cor(pop5.acv[1:18], time.6, method = "kendall"), cor(pop6.acv[1:18], time.6, method = "kendall"),
                     cor(pop7.acv[1:18], time.6, method = "kendall"), cor(pop8.acv[1:18], time.6, method = "kendall"))

constant.dt.tau.6 <- c(cor(pop1.dt[1:18], time.6, method = "kendall"), cor(pop2.dt[1:18], time.6, method = "kendall"),
                            cor(pop3.dt[1:18], time.6, method = "kendall"), cor(pop4.dt[1:18], time.6, method = "kendall"))
warming.dt.tau.6 <- c(cor(pop5.dt[1:18], time.6, method = "kendall"), cor(pop6.dt[1:18], time.6, method = "kendall"),
                            cor(pop7.dt[1:18], time.6, method = "kendall"), cor(pop8.dt[1:18], time.6, method = "kendall"))
```
...
```{r}
AUC_mean_data <- calc_auc(warming.mean.tau.6, constant.mean.tau.6); AUC_mean_data
AUC_sk_data <- calc_auc(warming.sk.tau.6, constant.sk.tau.6); AUC_sk_data
AUC_kt_data <- calc_auc(warming.kt.tau.6, constant.kt.tau.6); AUC_kt_data
AUC_var_data <- calc_auc(warming.var.tau.6, constant.var.tau.6); AUC_var_data
AUC_cv_data <- calc_auc(warming.cv.tau.6, constant.cv.tau.6); AUC_cv_data
AUC_id_data <- calc_auc(warming.id.tau.6, constant.id.tau.6); AUC_id_data
AUC_fdv_data <- calc_auc(warming.fdv.tau.6, constant.fdv.tau.6); AUC_fdv_data
AUC_ac_data <- calc_auc(warming.ac.tau.6, constant.ac.tau.6); AUC_ac_data
AUC_acv_data <- calc_auc(warming.acv.tau.6, constant.acv.tau.6); AUC_acv_data
AUC_dt_data <- calc_auc(warming.dt.tau.6, constant.dt.tau.6); AUC_dt_data
```
...
AUC_6 <- data.frame(metrics, AUC_6); AUC_6
```
...
AUC_15 <- data.frame(metrics, AUC_15); AUC_15
```
...
## Plot
plot(1:10, AUC_15$AUC_15, type = "p", 
...
```{r}
## Standard deviation
pop1.sd <- SlidingWindow(FUN = "sd", data = sub1$status.sum, window = 10, step = 1)
pop2.sd <- SlidingWindow(FUN = "sd", data = sub2$status.sum, window = 10, step = 1)
pop3.sd <- SlidingWindow(FUN = "sd", data = sub3$status.sum, window = 10, step = 1)
pop4.sd <- SlidingWindow(FUN = "sd", data = sub4$status.sum, window = 10, step = 1)
pop5.sd <- SlidingWindow(FUN = "sd", data = sub5$status.sum, window = 10, step = 1)
pop6.sd <- SlidingWindow(FUN = "sd", data = sub6$status.sum, window = 10, step = 1)
pop7.sd <- SlidingWindow(FUN = "sd", data = sub7$status.sum, window = 10, step = 1)
pop8.sd <- SlidingWindow(FUN = "sd", data = sub8$status.sum, window = 10, step = 1)

## Mean
pop1.mean <- SlidingWindow(FUN = "mean", data = sub1$status.sum, window = 10, step = 1)
pop2.mean <- SlidingWindow(FUN = "mean", data = sub2$status.sum, window = 10, step = 1)
pop3.mean <- SlidingWindow(FUN = "mean", data = sub3$status.sum, window = 10, step = 1)
pop4.mean <- SlidingWindow(FUN = "mean", data = sub4$status.sum, window = 10, step = 1)
pop5.mean <- SlidingWindow(FUN = "mean", data = sub5$status.sum, window = 10, step = 1)
pop6.mean <- SlidingWindow(FUN = "mean", data = sub6$status.sum, window = 10, step = 1)
pop7.mean <- SlidingWindow(FUN = "mean", data = sub7$status.sum, window = 10, step = 1)
pop8.mean <- SlidingWindow(FUN = "mean", data = sub8$status.sum, window = 10, step = 1)

## Skewness
pop1.sk <- SlidingWindow(FUN = "skewness", data = sub1$status.sum, window = 10, step = 1)
pop2.sk <- SlidingWindow(FUN = "skewness", data = sub2$status.sum, window = 10, step = 1)
pop3.sk <- SlidingWindow(FUN = "skewness", data = sub3$status.sum, window = 10, step = 1)
pop4.sk <- SlidingWindow(FUN = "skewness", data = sub4$status.sum, window = 10, step = 1)
pop5.sk <- SlidingWindow(FUN = "skewness", data = sub5$status.sum, window = 10, step = 1)
pop6.sk <- SlidingWindow(FUN = "skewness", data = sub6$status.sum, window = 10, step = 1)
pop7.sk <- SlidingWindow(FUN = "skewness", data = sub7$status.sum, window = 10, step = 1)
pop8.sk <- SlidingWindow(FUN = "skewness", data = sub8$status.sum, window = 10, step = 1)

## Kurtosis
pop1.kt <- SlidingWindow(FUN = "kurtosis", data = sub1$status.sum, window = 10, step = 1)
pop2.kt <- SlidingWindow(FUN = "kurtosis", data = sub2$status.sum, window = 10, step = 1)
pop3.kt <- SlidingWindow(FUN = "kurtosis", data = sub3$status.sum, window = 10, step = 1)
pop4.kt <- SlidingWindow(FUN = "kurtosis", data = sub4$status.sum, window = 10, step = 1)
pop5.kt <- SlidingWindow(FUN = "kurtosis", data = sub5$status.sum, window = 10, step = 1)
pop6.kt <- SlidingWindow(FUN = "kurtosis", data = sub6$status.sum, window = 10, step = 1)
pop7.kt <- SlidingWindow(FUN = "kurtosis", data = sub7$status.sum, window = 10, step = 1)
pop8.kt <- SlidingWindow(FUN = "kurtosis", data = sub8$status.sum, window = 10, step = 1)
```
...
constant.mean.tau.30 <- c(cor(pop1.mean[1:10], time.30, method = "kendall"), cor(pop2.mean[1:10], time.30, method = "kendall"),
                      cor(pop3.mean[1:10], time.30, method = "kendall"), cor(pop4.mean[1:10], time.30, method = "kendall"))
warming.mean.tau.30 <- c(cor(pop5.mean[1:10], time.30, method = "kendall"), cor(pop6.mean[1:10], time.30, method = "kendall"),
                      cor(pop7.mean[1:10], time.30, method = "kendall"), cor(pop8.mean[1:10], time.30, method = "kendall"))

constant.sk.tau.30 <- c(cor(pop1.sk[1:10], time.30, method = "kendall"), cor(pop2.sk[1:10], time.30, method = "kendall"),
                          cor(pop3.sk[1:10], time.30, method = "kendall"), cor(pop4.sk[1:10], time.30, method = "kendall"))
warming.sk.tau.30 <- c(cor(pop5.sk[1:10], time.30, method = "kendall"), cor(pop6.sk[1:10], time.30, method = "kendall"),
                          cor(pop7.sk[1:10], time.30, method = "kendall"), cor(pop8.sk[1:10], time.30, method = "kendall"))

constant.kt.tau.30 <- c(cor(pop1.kt[1:10], time.30, method = "kendall"), cor(pop2.kt[1:10], time.30, method = "kendall"),
                          cor(pop3.kt[1:10], time.30, method = "kendall"), cor(pop4.kt[1:10], time.30, method = "kendall"))
warming.kt.tau.30 <- c(cor(pop5.kt[1:10], time.30, method = "kendall"), cor(pop6.kt[1:10], time.30, method = "kendall"),
                          cor(pop7.kt[1:10], time.30, method = "kendall"), cor(pop8.kt[1:10], time.30, method = "kendall"))

constant.var.tau.30 <- c(cor(pop1.var[1:10], time.30, method = "kendall"), cor(pop2.var[1:10], time.30, method = "kendall"),
                          cor(pop3.var[1:10], time.30, method = "kendall"), cor(pop4.var[1:10], time.30, method = "kendall"))
warming.var.tau.30<- c(cor(pop5.var[1:10], time.30, method = "kendall"), cor(pop6.var[1:10], time.30, method = "kendall"),
                         cor(pop7.var[1:10], time.30, method = "kendall"), cor(pop8.var[1:10], time.30, method = "kendall"))

constant.cv.tau.30 <- c(cor(pop1.cv[1:10], time.30, method = "kendall"), cor(pop2.cv[1:10], time.30, method = "kendall"),
                    cor(pop3.cv[1:10], time.30, method = "kendall"), cor(pop4.cv[1:10], time.30, method = "kendall"))
warming.cv.tau.30 <- c(cor(pop5.cv[1:10], time.30, method = "kendall"), cor(pop6.cv[1:10], time.30, method = "kendall"),
                    cor(pop7.cv[1:10], time.30, method = "kendall"), cor(pop8.cv[1:10], time.30, method = "kendall"))

constant.id.tau.30 <- c(cor(pop1.id[1:10], time.30, method = "kendall"), cor(pop2.id[1:10], time.30, method = "kendall"),
                    cor(pop3.id[1:10], time.30, method = "kendall"), cor(pop4.id[1:10], time.30, method = "kendall"))
warming.id.tau.30 <- c(cor(pop5.id[1:10], time.30, method = "kendall"), cor(pop6.id[1:10], time.30, method = "kendall"),
                    cor(pop7.id[1:10], time.30, method = "kendall"), cor(pop8.id[1:10], time.30, method = "kendall"))

constant.fdv.tau.30 <- c(cor(pop1.fdv[1:10], time.30, method = "kendall"), cor(pop2.fdv[1:10], time.30, method = "kendall"),
                                     cor(pop3.fdv[1:10], time.30, method = "kendall"), cor(pop4.fdv[1:10], time.30, method = "kendall"))
warming.fdv.tau.30 <- c(cor(pop5.fdv[1:10], time.30, method = "kendall"), cor(pop6.fdv[1:10], time.30, method = "kendall"),
                                     cor(pop7.fdv[1:10], time.30, method = "kendall"), cor(pop8.fdv[1:10], time.30, method = "kendall"))

constant.ac.tau.30 <- c(cor(pop1.ac[1:10], time.30, method = "kendall"), cor(pop2.ac[1:10], time.30, method = "kendall"),
                    cor(pop3.ac[1:10], time.30, method = "kendall"), cor(pop4.ac[1:10], time.30, method = "kendall"))
warming.ac.tau.30 <- c(cor(pop5.ac[1:10], time.30, method = "kendall"), cor(pop6.ac[1:10], time.30, method = "kendall"),
                    cor(pop7.ac[1:10], time.30, method = "kendall"), cor(pop8.ac[1:10], time.30, method = "kendall"))

constant.acv.tau.30 <- c(cor(pop1.acv[1:10], time.30, method = "kendall"), cor(pop2.acv[1:10], time.30, method = "kendall"),
                     cor(pop3.acv[1:10], time.30, method = "kendall"), cor(pop4.acv[1:10], time.30, method = "kendall"))
warming.acv.tau.30 <- c(cor(pop5.acv[1:10], time.30, method = "kendall"), cor(pop6.acv[1:10], time.30, method = "kendall"),
                     cor(pop7.acv[1:10], time.30, method = "kendall"), cor(pop8.acv[1:10], time.30, method = "kendall"))

constant.dt.tau.30 <- c(cor(pop1.dt[1:10], time.30, method = "kendall"), cor(pop2.dt[1:10], time.30, method = "kendall"),
                            cor(pop3.dt[1:10], time.30, method = "kendall"), cor(pop4.dt[1:10], time.30, method = "kendall"))
warming.dt.tau.30 <- c(cor(pop5.dt[1:10], time.30, method = "kendall"), cor(pop6.dt[1:10], time.30, method = "kendall"),
                            cor(pop7.dt[1:10], time.30, method = "kendall"), cor(pop8.dt[1:10], time.30, method = "kendall"))
```

## Area Under Curve (AUC) Tests

```{r}
AUC_mean_data <- calc_auc(warming.mean.tau.30, constant.mean.tau.30); AUC_mean_data
AUC_sk_data <- calc_auc(warming.sk.tau.30, constant.sk.tau.30); AUC_sk_data
AUC_kt_data <- calc_auc(warming.kt.tau.30, constant.kt.tau.30); AUC_kt_data
AUC_var_data <- calc_auc(warming.var.tau.30, constant.var.tau.30); AUC_var_data
AUC_cv_data <- calc_auc(warming.cv.tau.30, constant.cv.tau.30); AUC_cv_data
AUC_id_data <- calc_auc(warming.id.tau.30, constant.id.tau.30); AUC_id_data
AUC_fdv_data <- calc_auc(warming.fdv.tau.30, constant.fdv.tau.30); AUC_fdv_data
AUC_ac_data <- calc_auc(warming.ac.tau.30, constant.ac.tau.30); AUC_ac_data
AUC_acv_data <- calc_auc(warming.acv.tau.30, constant.acv.tau.30); AUC_acv_data
AUC_dt_data <- calc_auc(warming.dt.tau.30, constant.dt.tau.30); AUC_dt_data
```
...
AUC_30 <- data.frame(metrics, AUC_30); AUC_30
...
plot(1:10, AUC_6$AUC_6, col = "orchid", pch = 19,
     type = "p", main = "Empirical Data, All Populations", xaxt = "none", xlab = "", ylim = c(0, 1), ylab = "AUC")
points(1:10, AUC_15$AUC_15, col = "orange", pch = 17, size = 5)
points(1:10, AUC_30$AUC_30, col = "forestgreen", pch = 19)
abline(h = 0.5, lty = 3)
axis(side = 1, at = 1:10, labels = metrics_full, las = 2)
...
plot(1:10, AUC_6$AUC_6, col = "orchid", pch = 19,
     type = "p", main = "Empirical Data, All Populations", xaxt = "none", xlab = "", ylim = c(0, 1), ylab = "AUC")
points(1:10, AUC_15$AUC_15, col = "orange", pch = 17)
points(1:10, AUC_30$AUC_30, col = "forestgreen", pch = 19)
abline(h = 0.5, lty = 3)
axis(side = 1, at = 1:10, labels = metrics_full)
dev.off()
