...
## Adding `1e-10` to Every Abundance Value:
...
## Using Detrended Data (Bandwidth = 1)
...
Okay, that looks better (except for decay time... Back to that in a minute...).

### Computing Kendall's $\tau$s and AUCs
