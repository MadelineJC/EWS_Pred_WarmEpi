...
### **Autocorrelation and Autoacvariance**
...
plot(constant.sims.acv.5[ ,1], type = "n",
     main = "5 Day Sliding Window", xlab = "Time", ylab = "Autoacvariance", ylim = c(-2, 10))
for(i in 1:200){
  lines(constant.sims.acv.5[ ,i], col = alpha("cornflowerblue", 0.2), lwd = 2)
}
abline(v = 60, col = "black", lwd = 2, lty = 2)
plot(warming.sims.acv.5[ ,1], type = "n",
     main = "5 Day Sliding Window", xlab = "Time", ylab = "Autoacvariance", ylim = c(-5, 40))
for(i in 1:200){
...
for(i in 1:num.of.sims){
  for(j in 1:55){
    suppressWarnings(constant.sims.dt.5[j, i] <- -j/log(constant.sims.cor.5[j, i]))
    suppressWarnings(warming.sims.dt.5[j, i] <- -j/log(warming.sims.cor.5[j, i]))
  }
}
...
plot(constant.sims.acv.15[ ,1], type = "n",
     main = "15 Day Sliding Window", xlab = "Time", ylab = "Autoacvariance", ylim = c(-1, 30))
for(i in 1:200){
  lines(constant.sims.acv.15[ ,i], col = alpha("cornflowerblue", 0.2), lwd = 2)
}
abline(v = 60, col = "black", lwd = 2, lty = 2)
plot(warming.sims.acv.15[ ,1], type = "n",
     main = "15 Day Sliding Window", xlab = "Time", ylab = "Autoacvariance", ylim = c(-1, 250))
for(i in 1:200){
...
plot(constant.sims.acv.30[ ,1], type = "n",
     main = "30 Day Sliding Window", xlab = "Time", ylab = "Autoacvariance", ylim = c(-1, 40))
for(i in 1:200){
  lines(constant.sims.acv.30[ ,i], col = alpha("cornflowerblue", 0.2), lwd = 2)
}
abline(v = 60, col = "black", lwd = 2, lty = 2)
plot(warming.sims.acv.30[ ,1], type = "n",
     main = "30 Day Sliding Window", xlab = "Time", ylab = "Autoacvariance", ylim = c(-1, 400))
for(i in 1:200){
...
for(i in 1:num.of.sims){
  for(j in 1:30){
    suppressWarnings(constant.sims.dt.30[j, i] <- -j/log(constant.sims.cor.30[j, i]))
    suppressWarnings(warming.sims.dt.30[j, i] <- -j/log(warming.sims.cor.30[j, i]))
  }
}
...
```{r}
AUC_variance_5 <- calc_auc(warming.sims.var.5.tau, constant.sims.var.5.tau); AUC_variance_5
AUC_mean_5 <- calc_auc(warming.sims.mean.5.tau, constant.sims.mean.5.tau); AUC_mean_5
AUC_kurtosis_5 <- calc_auc(warming.sims.kt.5.tau, constant.sims.kt.5.tau); AUC_kurtosis_5
AUC_skewness_5 <- calc_auc(warming.sims.sk.5.tau, constant.sims.sk.5.tau); AUC_skewness_5
...
```{r}
AUC_variance_15 <- calc_auc(warming.sims.var.15.tau, constant.sims.var.15.tau); AUC_variance_15
AUC_mean_15 <- calc_auc(warming.sims.mean.15.tau, constant.sims.mean.15.tau); AUC_mean_15
AUC_kurtosis_15 <- calc_auc(warming.sims.kt.15.tau, constant.sims.kt.15.tau); AUC_kurtosis_15
AUC_skewness_15 <- calc_auc(warming.sims.sk.15.tau, constant.sims.sk.15.tau); AUC_skewness_15
...
```{r}
AUC_variance_30 <- calc_auc(warming.sims.var.30.tau, constant.sims.var.30.tau); AUC_variance_30
AUC_mean_30 <- calc_auc(warming.sims.mean.30.tau, constant.sims.mean.30.tau); AUC_mean_30
AUC_kurtosis_30 <- calc_auc(warming.sims.kt.30.tau, constant.sims.kt.30.tau); AUC_kurtosis_30
AUC_skewness_30 <- calc_auc(warming.sims.sk.30.tau, constant.sims.sk.30.tau); AUC_skewness_30
...
```{r}
metrics_full <- c("Mean", "Skewness", "Kurtosis", "Variance", "acvariance", "Index of Dispersion", "First Difference Variance", "Autocorrelation", "Autoacvariance", "Decay Time")
