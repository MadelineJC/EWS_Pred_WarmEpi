...
```{r}
summary(constant.sims.ac.15.tau); summary(warming.sims.ac.15.tau)
(length(warming.sims.ac.15.tau) - length(which(warming.sims.ac.15.tau < 0)))/length(warming.sims.ac.15.tau)
(length(warming.sims.ac.15.tau) - length(which(warming.sims.ac.15.tau < median(constant.sims.ac.15.tau))))/length(warming.sims.ac.15.tau)
...
# Comparing Control and Treatment Populations Directly

```{r}
emp.ktaus <- data.frame(
  subpop = c("constant.1", "constant.2", "constant.3", "constant.4", "warming.1", "warming.2", "warming.3", "warming.4"),
