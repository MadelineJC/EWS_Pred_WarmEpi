...
sub1.sk.tau <- constant.skewness.tau[1]
sub2.sk.tau <- constant.skewness.tau[2]
sub3.sk.tau <- constant.skewness.tau[3]
sub4.sk.tau <- constant.skewness.tau[4]
sub5.sk.tau <- warming.skewness.tau[1]
sub6.sk.tau <- warming.skewness.tau[2]
sub7.sk.tau <- warming.skewness.tau[3]
sub8.sk.tau <- warming.skewness.tau[4]

sub1.kt.tau <- constant.kurtosis.tau[1]
sub2.kt.tau <- constant.kurtosis.tau[2]
sub3.kt.tau <- constant.kurtosis.tau[3]
sub4.kt.tau <- constant.kurtosis.tau[4]
sub5.kt.tau <- warming.kurtosis.tau[1]
sub6.kt.tau <- warming.kurtosis.tau[2]
sub7.kt.tau <- warming.kurtosis.tau[3]
sub8.kt.tau <- warming.kurtosis.tau[4]

sub1.var.tau <- constant.variance.tau[1]
sub2.var.tau <- constant.variance.tau[2]
sub3.var.tau <- constant.variance.tau[3]
sub4.var.tau <- constant.variance.tau[4]
sub5.var.tau <- warming.variance.tau[1]
sub6.var.tau <- warming.variance.tau[2]
sub7.var.tau <- warming.variance.tau[3]
sub8.var.tau <- warming.variance.tau[4]
...
sub1.fdv.tau <- constant.first.diff.variance.tau[1]
sub2.fdv.tau <- constant.first.diff.variance.tau[2]
sub3.fdv.tau <- constant.first.diff.variance.tau[3]
sub4.fdv.tau <- constant.first.diff.variance.tau[4]
sub5.fdv.tau <- warming.first.diff.variance.tau[1]
sub6.fdv.tau <- warming.first.diff.variance.tau[2]
sub7.fdv.tau <- warming.first.diff.variance.tau[3]
sub8.fdv.tau <- warming.first.diff.variance.tau[4]
...
sub1.acv.tau <- constant.cov.tau[1]
sub2.acv.tau <- constant.cov.tau[2]
sub3.acv.tau <- constant.cov.tau[3]
sub4.acv.tau <- constant.cov.tau[4]
sub5.acv.tau <- warming.cov.tau[1]
sub6.acv.tau <- warming.cov.tau[2]
sub7.acv.tau <- warming.cov.tau[3]
sub8.acv.tau <- warming.cov.tau[4]

sub1.dt.tau <- constant.decay.time.tau[1]
sub2.dt.tau <- constant.decay.time.tau[2]
sub3.dt.tau <- constant.decay.time.tau[3]
sub4.dt.tau <- constant.decay.time.tau[4]
sub5.dt.tau <- warming.decay.time.tau[1]
sub6.dt.tau <- warming.decay.time.tau[2]
sub7.dt.tau <- warming.decay.time.tau[3]
sub8.dt.tau <- warming.decay.time.tau[4]
```
