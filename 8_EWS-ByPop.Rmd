...
sub1.nulls <- list(); sub1.nulls[[1]] <- sub1.crit
sub2.nulls <- list(); sub2.nulls[[1]] <- sub2.crit
sub3.nulls <- list(); sub3.nulls[[1]] <- sub3.crit
sub4.nulls <- list(); sub4.nulls[[1]] <- sub4.crit
sub5.nulls <- list(); sub5.nulls[[1]] <- sub5.crit
sub6.nulls <- list(); sub6.nulls[[1]] <- sub6.crit
sub7.nulls <- list(); sub7.nulls[[1]] <- sub7.crit
sub8.nulls <- list(); sub8.nulls[[1]] <- sub8.crit

set.seed(123) 
for (i in 1:10000){
  sub1.nulls[[i + 1]] <- sample(sub1.crit, length(sub1.crit), replace = FALSE)
  sub2.nulls[[i + 1]] <- sample(sub2.crit, length(sub2.crit), replace = FALSE)
  sub3.nulls[[i + 1]] <- sample(sub3.crit, length(sub3.crit), replace = FALSE)
  sub4.nulls[[i + 1]] <- sample(sub4.crit, length(sub4.crit), replace = FALSE)
  sub5.nulls[[i + 1]] <- sample(sub5.crit, length(sub5.crit), replace = FALSE)
  sub6.nulls[[i + 1]] <- sample(sub6.crit, length(sub6.crit), replace = FALSE)
  sub7.nulls[[i + 1]] <- sample(sub7.crit, length(sub7.crit), replace = FALSE)
  sub8.nulls[[i + 1]] <- sample(sub8.crit, length(sub8.crit), replace = FALSE)
} 
