...
-   **We don't know how many *Daphnia* were in the experimental population, so this might not be as comparative as we want it to be**
...
```{r}
rbinom(12, 1, 9/169) # Where 12 is the number of samples, 9 is the true prevalence, and 169 is N

# We want to count the number of 1s, and use that as our sampled prevalence
set.seed(123); infec.samp <- rbinom(12, 1, 9/169)
